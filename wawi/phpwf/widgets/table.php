    ...
    for($i=0;$i<$rows;$i++) {
      ...
      for($j=0;$j<$cols;$j++) {
        ...
        if($j==($col-1)){
          ...
          // lösch button einblenden wenn delete kriterium 1
          if ($showDelete) {
            ...
            if ($this->table->Table[$i][2] == 1) {
              ...
              $menu .= "</a>&nbsp;"; 
            } // end of if - anzeige des löschen buttons oder nicht nach wert
          } // end of if - anzeige von löschen oder nicht nach funktionsparmeter
...
/**
  * Creates a specific form for OIC Module Statistik Auswertung / Ordnerübersicht
  *
  * @param  Int     $col            Column number for menu
  * @param  String  $module         Modulename used to build links (e.g. personenform, hutform, etc.)
  * 
...
/**
  * Creates a specific form for OIC Module Statistik Verwaltung / Ordnerübersicht
  *
  * @param  Int     $col            Column number for menu
  * @param  String  $module         Modulename used to build links (e.g. personenform, hutform, etc.)
  * 
...
/**
  * Creates a specific form for OIC Module Statistik Verwaltung / Formelübersicht innerhalb eines Ordners
  *
  * @param  Int     $col            Column number for menu
  * @param  String  $module         Modulename used to build links (e.g. personenform, hutform, etc.)
  * 
    ...
    for($i=0; $i<$rows; $i++) {
	  ...
	  //echo $this->table->Table[$i][1]."<br>";
          ...
          if ($id != -1) {
            ...
            $menu .= "<img src=\"./sip/themes/[THEME]/images/buttons/bu_add.gif\" border=\"0\" alt=\"Nach diesem hinzufügen\">"; 
            $menu .= "</a>&nbsp;"; 
          } else {
            $menu .= "<a href=\"index.php?module=".$module."&action=add&id=$id\">"; 
            $menu .= "<img src=\"./sip/themes/[THEME]/images/buttons/bu_add.gif\" border=\"0\" alt=\"Formel hinzufügen\">"; 
            $menu .= "</a>&nbsp;"; 
          } // end of if
