<?php
include ("_gen/widget.gen.inventur.php");

class WidgetInventur extends WidgetGeninventur 
{
  private $app;
  function WidgetInventur(&$app,$parsetarget)
  {
    $this->app = &$app;
    $this->parsetarget = $parsetarget;
    parent::WidgetGeninventur($app,$parsetarget);
    $this->ExtendsForm();
  }
  ...
  function ExtendsForm()
  {
    ...
    $status = $this->app->erp->GetStatusInventur();
