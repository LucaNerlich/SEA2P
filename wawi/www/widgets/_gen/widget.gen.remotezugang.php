...
class WidgetGenremotezugang
{
  ...
  public function WidgetGenremotezugang($app,$parsetarget)
  {
    $this->app = $app;
  ...
  public function remotezugangDelete()
  {
    
    $this->form->Execute("remotezugang","delete");

    $this->remotezugangList();
  }
  ...
  function Form()
  {
    $this->form = $this->app->FormHandler->CreateNew("remotezugang");
    $this->form->UseTable("remotezugang");
    $this->form->UseTemplate("remotezugang.tpl",$this->parsetarget);
