...
class WidgetGengruppen
{
  ...
  public function WidgetGengruppen($app,$parsetarget)
  {
    $this->app = $app;
  ...
  function Form()
  {
    ...
    $field = new HTMLInput("kennziffer","text","","80","","","","","","","0");
    $this->form->NewField($field);

    $field = new HTMLTextarea("internebemerkung",10,130);   
    $this->form->NewField($field);
    ...
    $field = new HTMLInput("grundrabatt","text","","20","","","","","","","0");
    $this->form->NewField($field);
    ...
    $field = new HTMLCheckbox("zentralregulierung","","","1","0");
    $this->form->NewField($field);

    $field = new HTMLCheckbox("zentralerechnung","","","1","0");
    $this->form->NewField($field);

    $field = new HTMLSelect("rechnung_periode",0,"rechnung_periode");
    ...
    $field = new HTMLInput("rechnung_anzahlpapier","text","","5","","","","","","","0");
    $this->form->NewField($field);

    $field = new HTMLCheckbox("rechnung_permail","","","1","0");
    $this->form->NewField($field);

    $field = new HTMLInput("rechnung_name","text","","50","","","","","","","0");
    $this->form->NewField($field);

    $field = new HTMLInput("rechnung_abteilung","text","","50","","","","","","","0");
    $this->form->NewField($field);

    $field = new HTMLInput("rechnung_strasse","text","","50","","","","","","","0");
    $this->form->NewField($field);
    ...
    $field = new HTMLCheckbox("dta_aktiv","","","1","0");
    $this->form->NewField($field);

    $field = new HTMLSelect("dta_variante",0,"dta_variante");
    ...
    $field = new HTMLTextarea("dtavariablen",10,50);   
    $this->form->NewField($field);

    $field = new HTMLSelect("dta_periode",0,"dta_periode");
    ...
    $field = new HTMLInput("dta_dateiname","text","","50","","","","","","","0");
    $this->form->NewField($field);

    $field = new HTMLInput("dta_mail","text","","50","","","","","","","0");
    $this->form->NewField($field);

    $field = new HTMLInput("dta_mail_betreff","text","","50","","","","","","","0");
    $this->form->NewField($field);

    $field = new HTMLTextarea("dta_mail_text",10,50);   
    $this->form->NewField($field);
