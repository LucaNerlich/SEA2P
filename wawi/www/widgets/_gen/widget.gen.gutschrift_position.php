...
class WidgetGengutschrift_position
{
  ...
  public function WidgetGengutschrift_position($app,$parsetarget)
  {
    $this->app = $app;
  ...
  public function gutschrift_positionDelete()
  {
    
    $this->form->Execute("gutschrift_position","delete");

    $this->gutschrift_positionList();
  }
  ...
  function Form()
  {
    $this->form = $this->app->FormHandler->CreateNew("gutschrift_position");
    $this->form->UseTable("gutschrift_position");
    $this->form->UseTemplate("gutschrift_position.tpl",$this->parsetarget);
