...
class WidgetGenterminals
{
  ...
  public function WidgetGenterminals($app,$parsetarget)
  {
    $this->app = $app;
  ...
  public function terminalsDelete()
  {
    
    $this->form->Execute("terminals","delete");
  ...
  function Form()
  {
    $this->form = $this->app->FormHandler->CreateNew("terminals");
    $this->form->UseTable("terminals");
    $this->form->UseTemplate("terminals.tpl",$this->parsetarget);
