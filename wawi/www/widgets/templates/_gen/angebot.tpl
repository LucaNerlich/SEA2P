...
<table width="100%">
  ...
  <tr><td>Datum:</td><td>[DATUM][MSGDATUM]</td></tr>
	<tr><td>Liefertermin:</td><td>[LIEFERDATUM][MSGLIEFERDATUM]</td></tr>
...
<fieldset style="background-color: #FFDEAD;"><legend>Abweichende Lieferadresse</legend>
   <table height="160">
          <tr><td width="120">Name:</td><td>[LIEFERNAME][MSGLIEFERNAME]</td></tr>
...
<tr><td width="120">Versandart:</td><td>[VERSANDART][MSGVERSANDART]</td></tr>
...
<table width="100%">
<tr><td width="120">UST ID:</td><td>[USTID][MSGUSTID]</td></tr>
