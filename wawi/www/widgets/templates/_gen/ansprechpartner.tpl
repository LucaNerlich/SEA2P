...
<table width="930">
 ...
 <tr><td >Anrede:</td><td>[TYP][MSGTYP]</td>
          <td>&nbsp;</td>
            <td></td><td></td></tr>
          ...
          <tr><td>Zust&auml;ndig bzw. Position</td><td>[BEREICH][MSGBEREICH]</td><td>&nbsp;</td>
      ...
      <tr><td>Titel:</td><td>[TITEL][MSGTITEL]</td>
          ...
          <tr><td>Land:</td><td colspan="2">[EPROO_SELECT_LAND_ANSPRECHPARTNER]</td>
          </tr>
...
<td></td>
    ...
    <input type="submit"
    value="Ansprechpartner speichern" /> 
    </td>
    </tr>
