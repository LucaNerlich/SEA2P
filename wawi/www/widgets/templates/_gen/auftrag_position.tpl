 ...
 <table class="tableborder" border="0" cellpadding="3" cellspacing="0" width="100%">
    <tbody>
      ...
      <tr valign="top" colspan="3">
        ...
        <tr><td>Kein Rabatt anwenden oder Porto berechnen:</td><td>[KEINRABATTERLAUBT][MSGKEINRABATTERLAUBT]</td></tr>
        [ENDEDISABLEVERBAND]
        <tr><td>Rabatt[STARTDISABLEVERBAND] (wird berechnet aus Grund- und Rabatt 1 - 5):
<script type="text/javascript">
$( document ).ready(function() {
    document.getElementById('rabatt').readOnly = true;
});
</script>
[ENDEDISABLEVERBAND]:</td><td>[RABATT][MSGRABATT]&nbsp;<i>(in Prozent z.B. 10 = 10%)</i></td></tr>
