...
<table width="100%" height="160">
  ...
  <tr><td>Auftragsdatum:</td><td>[DATUM][MSGDATUM]</td></tr>
	<tr><td>Wunsch Liefertermin:</td><td>[LIEFERDATUM][MSGLIEFERDATUM]</td></tr>
...
<tr><td width="220">Zahlungsweise:</td><td>[ZAHLUNGSWEISE][MSGZAHLUNGSWEISE]
...
<table width="100%">
<tr><td width="220">F&uuml;r den Versand freigeben:</td><td>[AUTOVERSAND][MSGAUTOVERSAND]</td></tr>
...
<tr><td>UST-ID gepr&uuml;ft:</td><td>[UST_OK][MSGUST_OK]&nbsp;(Auftrag darf versendet werden) (ist bei Besteuerung Deutschland automatisch aktiviert)</td></tr>
