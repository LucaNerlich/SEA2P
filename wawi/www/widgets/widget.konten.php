<?php
include ("_gen/widget.gen.konten.php");

class WidgetKonten extends WidgetGenKonten 
{
  private $app;
  function WidgetKonten($app,$parsetarget)
  {
    $this->app = $app;
    $this->parsetarget = $parsetarget;
    parent::WidgetGenKonten($app,$parsetarget);
    $this->ExtendsForm();
  }
  ...
  {
    $this->app->YUI->TableSearch(INHALT,"kontenlist");
