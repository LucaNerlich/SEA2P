<?php
include ("_gen/widget.gen.eigenschaften.php");

class WidgetEigenschaften extends WidgetGenEigenschaften 
{
  private $app;
  function WidgetEigenschaften($app,$parsetarget)
  {
    $this->app = $app;
    $this->parsetarget = $parsetarget;
    parent::WidgetGenEigenschaften($app,$parsetarget);
    $this->ExtendsForm();
  }
