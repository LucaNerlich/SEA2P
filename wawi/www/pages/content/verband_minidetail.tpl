...
//-->
</script><div id="verband_minidetail_[ID]">
  
<script>
      $(function() {
    $( "#accordion[VERBANDID]" ).accordion({ autoHeight: true,fillSpace: true });
  });
  </script>
<style>
...
<div style="width:900px; height:100%; background-color:white; padding:20px;">
  <div>
		<br><h2>Offene Rechungen [LAGERLINK]</h2><hr>[RECHNUNGEN]
  ...
  <div>[RMA]</div>-->
<br><br>
<center><button onclick="printContent('verband_minidetail_[ID]')">Drucken</button></center>
</div>
