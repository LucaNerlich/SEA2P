...
<tr><td><h2 class="greyh2">Gesamt&uuml;bersicht Auftragseingang</h2></td><td><h2 class="greyh2">Statistik Auftr&auml;ge Heute</h2></td></tr>
<tr valign="top"><td width="50%" rowspan="3"><div id="placeholder" width="100%" height="400"></div></td><td>[STATISTIKHEUTE]</td></tr>
<tr valign="bottom"><td><h2 class="greyh2">Statistik Auftr&auml;ge Gestern</h2></td></tr>
<tr valign="top"><td>[STATISTIKGESTERN]</td></tr>


<tr><td width="50%"><h2 class="greyh2">Tages&uuml;bersicht Auftragseingang</h2></td><td><h2 class="greyh2">Top Artikel (Lager) letzten 90 Tage</td></tr>
