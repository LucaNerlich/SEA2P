...
<form name="firmendatenform" action="" method="POST"  enctype="multipart/form-data">
<div id="tabs">
<ul>
...
<br><center><input type="submit" name="submitFirmendaten" onclick="this.form.action += '#tabs-1';" value="Speichern"></center>
</div>
<div id="tabs-2">
...
<tr><td colspan="2"><input type="checkbox" name="seite_von_sichtbar" [SEITEVONSICHTBAR]>&nbsp;Seitennummerierung und Belegnr Ausrichtung&nbsp; <input type="text" name="seite_von_ausrichtung" value="[SEITEVONAUSRICHTUNG]" size="2">&nbsp;<i>(Werte: L=links, R=rechts oder C=zentriert)</i></td></tr>
...
<fieldset><legend>Formatierung</legend>
  ...
  <tr><td><br></td>
	...
	<tr><td>Abstand Adresszeile oben/unten (verschieben +- in mm)</td>
	...
	<td>Ausrichtung Infobox Text (L,R)</td>
...
<br><center><input type="submit" name="submitFirmendaten" onclick="this.form.action += '#tabs-2';" value="Speichern"></center>
</div>
...
<table width="100%">
  ...
  <tr><td>Angebot Text vor Artikeltabelle</td><td><textarea rows="2" cols="80" name="angebot_header">[ANGEBOT_HEADER]</textarea></td></tr>
  <tr><td>Angebot Text am Ende (nach Freitext)</td><td><textarea rows="2" cols="80" name="angebot_footer">[ANGEBOT_FOOTER]</textarea></td></tr>
  <tr><td>Angebot ohne Briefpapier</td><td><input type="checkbox" name="angebot_ohnebriefpapier" [ANGEBOT_OHNEBRIEFPAPIER]></td></tr>

  <tr><td>Auftrag Text vor Artikeltabelle</td><td><textarea rows="2" cols="80" name="auftrag_header">[AUFTRAG_HEADER]</textarea></td></tr>
  <tr><td>Auftrag Text am Ende (nach Freitext)</td><td><textarea rows="2" cols="80" name="auftrag_footer">[AUFTRAG_FOOTER]</textarea></td></tr>
  <tr><td>Auftrag ohne Briefpapier</td><td><input type="checkbox" name="auftrag_ohnebriefpapier" [AUFTRAG_OHNEBRIEFPAPIER]></td></tr>

  <tr><td>Rechnung Text vor Artikeltabelle</td><td><textarea rows="2" cols="80" name="rechnung_header">[RECHNUNG_HEADER]</textarea></td></tr>
  <tr><td>Rechnung Text am Ende (nach Freitext)</td><td><textarea rows="2" cols="80" name="rechnung_footer">[RECHNUNG_FOOTER]</textarea></td></tr>
  <tr><td>Rechnung ohne Briefpapier</td><td><input type="checkbox" name="rechnung_ohnebriefpapier" [RECHNUNG_OHNEBRIEFPAPIER]></td></tr>

  <tr><td>Lieferschein Text vor Artikeltabelle</td><td><textarea rows="2" cols="80" name="lieferschein_header">[LIEFERSCHEIN_HEADER]</textarea></td></tr>
  <tr><td>Lieferschein Text am Ende (nach Freitext)</td><td><textarea rows="2" cols="80" name="lieferschein_footer">[LIEFERSCHEIN_FOOTER]</textarea></td></tr>
  ...
  <tr><td>Gutschrift Text vor Artikeltabelle</td><td><textarea rows="2" cols="80" name="gutschrift_header">[GUTSCHRIFT_HEADER]</textarea><br><i>Variablen: {ART} (Gutschrift oder Stornorechnung)</i></td></tr>
  <tr><td>Gutschrift Text am Ende (nach Freitext)</td><td><textarea rows="2" cols="80" name="gutschrift_footer">[GUTSCHRIFT_FOOTER]</textarea></td></tr>
  ...
  <tr><td>Bestellung Text vor Artikeltabelle</td><td><textarea rows="2" cols="80" name="bestellung_header">[BESTELLUNG_HEADER]</textarea></td></tr>
  <tr><td>Bestellung Text am Ende (nach Freitext)</td><td><textarea rows="2" cols="80" name="bestellung_footer">[BESTELLUNG_FOOTER]</textarea></td></tr>
  ...
  <tr><td>Arbeitsnachweis Text vor Artikeltabelle</td><td><textarea rows="2" cols="80" name="arbeitsnachweis_header">[ARBEITSNACHWEIS_HEADER]</textarea></td></tr>
  <tr><td>Arbeitsnachweis Text am Ende (nach Freitext)</td><td><textarea rows="2" cols="80" name="arbeitsnachweis_footer">[ARBEITSNACHWEIS_FOOTER]</textarea></td></tr>
  ...
  <tr><td>Provisionsgutschrift Text vor Artikeltabelle</td><td><textarea rows="2" cols="80" name="provisionsgutschrift_header">[PROVISIONSGUTSCHRIFT_HEADER]</textarea></td></tr>
  <tr><td>Provisionsgutschrift Text am Ende (nach Freitext)</td><td><textarea rows="2" cols="80" name="provisionsgutschrift_footer">[PROVISIONSGUTSCHRIFT_FOOTER]</textarea></td></tr>

  <tr><td>EU-Lieferung Vermerk</td><td><textarea rows="2" cols="80" name="eu_lieferung_vermerk">[EU_LIEFERUNG_VERMERK]</textarea><br><i>Variablen: {USTID} {LAND}</i></td></tr>
  <tr><td>Export-Lieferung Vermerk</td><td><textarea rows="2" cols="80" name="export_lieferung_vermerk">[EXPORT_LIEFERUNG_VERMERK]</textarea><br><i>Variablen: {LAND}</i></td></tr>
</table>
</fieldset>

<br><center><input type="submit" name="submitFirmendaten" onclick="this.form.action += '#tabs-3';" value="Speichern"></center>
</div>
...
<table cellspacing="5" width="100%">
  <tr><td width="50">PHP mail() verwenden (Standard):</td><td><input type="checkbox" name="mailanstellesmtp" [MAILANSTELLESMTP]>&nbsp;<i>Standard falls kein SMTP Account vorhanden ist.</i></td></tr>
  <tr><td width="300">Benutzername (E-Mail):&nbsp;</td><td><input type="text" name="benutzername" size="25" value="[BENUTZERNAME]"></td></tr>
  <tr><td>Passwort:&nbsp;</td><td><input type="password" name="passwort" size="25" value="[PASSWORT]" AUTOCOMPLETE="off"></td></tr>
  <tr><td>Postausgangsserver:&nbsp;</td><td><input type="text" name="host" size="25" value="[HOST]"></td></tr>
  <tr><td>Port:&nbsp;</td><td><input type="text" name="port" size="4" value="[PORT]"></td></tr>
  <tr><td width="50">SSL:</td><td><input type="checkbox" name="ssl" [SSL]></td></tr>
  <tr><td width="50">Testmail:</td><td><input type="submit" name="submitFirmendaten" onclick="this.form.action += '#tabs-4';" value="Speichern">&nbsp;<input type="button" value="Testmail senden" onclick="window.location.href='index.php?module=firmendaten&action=testmail'">&nbsp;<i>(Bitte erst speichern und dann senden!</i>)</td></tr>
...
<table cellspacing="5" width="100%">
  ...
  <tr><td>Signatur</td><td><textarea name="signatur" rows="15" cols="80">[SIGNATUR]</textarea></td>
...
<br><center><input type="submit" name="submitFirmendaten" onclick="this.form.action += '#tabs-4';" value="Speichern"></center>
</div>
...
<br><center><input type="submit" name="submitFirmendaten" onclick="this.form.action += '#tabs-6';" value="Speichern"></center>
</div>
...
<table width="100%">
  ...
  <tr valign="top"><td></td><td>Satz Rechnung (sofort) (DE)</td><td><textarea name="zahlung_rechnung_sofort_de" rows="3" cols="80">[ZAHLUNG_RECHNUNG_SOFORT_DE]</textarea><br><i>z.B. Rechnung zahlbar sofort.</i></td></tr>
	...
	<i>z.B. Rechnung zahlbar innerhalb {ZAHLUNGSZIELTAGE} Tage bis zum {ZAHLUNGBISDATUM}.<br>Variabeln: {ZAHLUNGSZIELTAGE}, {ZAHLUNGBISDATUM}</i></td></tr>
 <tr><td></td><td>Rechnung Zahlungsziel in Tage</td><td><input type="text" name="zahlungszieltage" size="10" value="[ZAHLUNGSZIELTAGE]"></td></tr>
  ...
  <tr  valign="top"><td></td><td>Vorkasse Zahlungsbedingungen:</td><td><textarea name="zahlung_vorkasse_de" rows="3" cols="80">[ZAHLUNG_VORKASSE_DE]</textarea><br>
<i>Dieser Text erscheint auf dem Angebot, Auftrag und der Rechnung.</i></td></tr>
 ...
 <tr valign="top"><td></td><td>Nachnahme Zahlungsbedingungen:</td><td><textarea name="zahlung_nachnahme_de" rows="3" cols="80">[ZAHLUNG_NACHNAHME_DE]</textarea><br>
<i>Dieser Text erscheint auf dem Angebot, Auftrag und der Rechnung.</i></td></tr>


  <tr><td><input type="checkbox" name="zahlung_lastschrift" [ZAHLUNG_LASTSCHRIFT]></td><td>Lastschrift</td><td>
</td></tr>
 <tr valign="top"><td></td><td>Lastschrift Zahlungsbedingungen:</td><td><textarea name="zahlung_lastschrift_de" rows="3" cols="80">[ZAHLUNG_LASTSCHRIFT_DE]</textarea><br>
...
<tr valign="top"><td></td><td>Bar Zahlungsbedingungen:</td><td><textarea name="zahlung_bar_de" rows="3" cols="80">[ZAHLUNG_BAR_DE]</textarea><br>
<i>Dieser Text erscheint auf dem Angebot, Auftrag und der Rechnung.</i></td></tr>


  <tr><td><input type="checkbox" name="zahlung_paypal" [ZAHLUNG_PAYPAL]></td><td>Paypal</td><td></td></tr>
<tr  valign="top"><td></td><td>Paypal Zahlungsbedingungen:</td><td><textarea name="zahlung_paypal_de" rows="3" cols="80">[ZAHLUNG_PAYPAL_DE]</textarea><br>
<i>Dieser Text erscheint auf dem Angebot, Auftrag und der Rechnung.</i></td></tr>

  <tr><td><input type="checkbox" name="zahlung_kreditkarte" [ZAHLUNG_KREDITKARTE]></td><td>Kreditkarte</td><td></td></tr>
<tr  valign="top"><td></td><td>Kreditkarte Zahlungsbedingungen:</td><td><textarea name="zahlung_kreditkarte_de" rows="3" cols="80">[ZAHLUNG_KREDITKARTE_DE]</textarea><br>
<i>Dieser Text erscheint auf dem Angebot, Auftrag und der Rechnung.</i></td></tr>


  <tr><td><input type="checkbox" name="zahlung_amazon" [ZAHLUNG_AMAZON]></td><td>Amazon Payments</td><td></td></tr>
<tr  valign="top"><td></td><td>Amazon Zahlungsbedingungen:</td><td><textarea name="zahlung_amazon_de" rows="3" cols="80">[ZAHLUNG_AMAZON_DE]</textarea><br>
<i>Dieser Text erscheint auf dem Angebot, Auftrag und der Rechnung.</i></td></tr>

  <tr><td><input type="checkbox" name="zahlung_ratenzahlung" [ZAHLUNG_RATENZAHLUNG]></td><td>Ratenzahlung</td><td></td></tr>
<tr  valign="top"><td></td><td>Ratenzahlung Zahlungsbedingungen:</td><td><textarea name="zahlung_ratenzahlung_de" rows="3" cols="80">[ZAHLUNG_RATENZAHLUNG_DE]</textarea><br>
<i>Dieser Text erscheint auf dem Angebot, Auftrag und der Rechnung.</i></td></tr>
...
<br><center><input type="submit" name="submitFirmendaten" onclick="this.form.action += '#tabs-7';" value="Speichern"></center>
</div>
...
<br><center><input type="submit" name="submitFirmendaten" onclick="this.form.action += '#tabs-8';" value="Speichern"></center>
</div>
...
<fieldset><legend>Artikel Freifelder</legend>
    <table cellspacing="5">
          <tr><td>aktiviert</td><td><input type="checkbox" name="parameterundfreifelder" [PARAMETERUNDFREIFELDER]>&nbsp;<i>Freifelder im Artikel eingeblendet</i></td></tr>
...
<br><center><input type="submit" name="submitFirmendaten" onclick="this.form.action += '#tabs-9';" value="Speichern"></center>
</div>
...
<br><center><input type="submit" name="submitFirmendaten" onclick="this.form.action += '#tabs-10';" value="Speichern"></center>
</div>


<div id="tabs-11">
<fieldset><legend>XML API</legend>
<table cellspacing="5" width="100%">
...
<fieldset><legend>Adapterbox API</legend>
<table cellspacing="5" width="100%">
  <tr><td width="300">Adapterbox API akiviert</td><td><input type="checkbox" name="deviceenable" [DEVICEENABLE]></td></tr>
  <tr><td>Security Key</td><td><input type="text" name="devicekey" value="[DEVICEKEY]" size="40"></td></tr>
  <!--<tr><td>Device Seriennummern</td><td><textarea name="deviceserials" cols="40" rows="5">[DEVICESERIALS]</textarea></td></tr>-->
</table></fieldset>


<br><center><input type="submit" name="submitFirmendaten" onclick="this.form.action += '#tabs-11';" value="Speichern"></center>
</div>
...
<br><center><input type="submit" name="submitFirmendaten" onclick="this.form.action += '#tabs-12';" value="Speichern"></center>
</div>
