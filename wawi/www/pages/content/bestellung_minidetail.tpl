...
<tr><td class="auftraginfo_cell" colspan="2" width="50%"><b>Allgemein</b></td><td width="10" rowspan="8" class="auftraginfo_cell"></td><td class="auftraginfo_cell" colspan="2"><b>Zahlung</b></td></tr>
...
<tr valign="bottom"><td class="auftraginfo_cell">Lieferschein:</td><td class="auftraginfo_cell" nowrap>[LIEFERSCHEIN]</td><td class="auftraginfo_cell"></td><td class="auftraginfo_cell"></td></tr>
...
<table><tr><td>
Hinweise f&uuml;r Verbindlichkeiten:<br>
<textarea rows="5" cols="100" name="verbindlichkeiteninfo">[VERBINDLICHKEITENINFO]</textarea>
