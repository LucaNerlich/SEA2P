...
{
	document.getElementById("menge").value=value;
...
<h2 class="smartphone">Auslagern</h2>
<table align="center">
...
<tr><td><br></td></tr>
<tr><td><input type="button" value="+" name="submit" class="smartphone_mainbutton" onclick="AddValue()" style="width:50px">&nbsp;&nbsp;<input type="button" value="-" style="width:50px" name="submit" class="smartphone_mainbutton" onclick="SubValue()">&nbsp;&nbsp;<input type="button" value="1" style="width:50px" name="submit" class="smartphone_mainbutton" onclick="SetValue(1)"></td></tr>
<tr><td><br></td></tr>
<tr><td><input type="submit" value="buchen " name="submit" class="smartphone_mainbutton">&nbsp;<input type="button" value="abbrechen" class="smartphone_mainbutton" style="width:75px" onclick="window.location.href='index.php?module=mobile&action=cancel'"></td></tr>
