...
//-->
</script><div id="arbeitsnachweis_minidetail_[ID]">
...
<div style="width:900px; height:100%; background-color:white; padding:20px;">
  <div>
		<h2>Positionen</h2><hr><p>[POSITIONEN]</p>
			</div>
  ...
  <div>[RMA]</div>-->
<br><br>
<center><button onclick="printContent('arbeitsnachweis_minidetail_[ID]')">Drucken</button></center>
</div>
