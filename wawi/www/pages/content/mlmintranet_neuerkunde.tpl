...
<fieldset><legend>Anhang - Kaufvertrag oder Best&auml;tigung des Kunden für einen Eintrag in das MLM System</legend>
    <table width="100%">
          <tr valign="top"><td>Datei*:</td><td colspan="2"><input type="file" name="anhang"></td>
            <td colspan="2" align="right"></td></tr>
       </tr>
</table></fieldset>

<br>
<center><input type="submit" name="speichern" value="Neuen Kunden jetzt anlegen" />&nbsp;<br><br><i>Bitte pr&uuml;fen Sie vor dem Klicken auf "Neuen Kunden jetzt anlegen" ob alle Felder passen, da diese
anschlie&szlig;end nicht ge&auml;ndert werden k&ouml;nnen!</i></center>
</form>
</div>
