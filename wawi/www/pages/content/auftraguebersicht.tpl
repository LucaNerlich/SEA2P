...
<!--        <li><a href="#tabs-3">Offene Auftr&auml;ge</a></li>-->
        <li><a href="#tabs-2">Versandzentrum</a></li>
...
<tr>
  ...
  <td><input type="checkbox" id="ustpruefung"><br>UST-Pr&uuml;fung fehlt</td>
  ...
  <td><input type="checkbox" id="manuellepruefung"><br>Manuelle Pr&uuml;fungen</td>
...
[TAB2]
<table width="100%"><tr><td><input type="submit" value="Auto-Versand starten" name="submit"></td>
</tr></table>
</form>
</div>
<!--
