...
<fieldset><legend>Benutzer</legend>
    <table width="100%">
         <tr><td>Benutzer ist aktiv:</td><td><input type="checkbox" name="activ" value="1" [ACTIVCHECKED]>&nbsp;</td></tr>
    <tr><td>Benutzername:*</td><td><input type="text" name="username" value="[USERNAME]" size="40"></td><td></tr>
 	<tr valign="top"><td width="200">Adresse aus Stammdaten:</td><td width="70%">[ADRESSEAUTOSTART]<input type="text" name="adresse" id="adresse" value="[ADRESSE]" size="40">[ADRESSEAUTOEND]&nbsp;<i>Jeder Benutzer muss auf eine eindeutige Adresse verweisen.</i></td></tr>

		<tr><td>Passwort:*</td><td><input type="password" name="password" value="[PASSWORD]" size="40" AUTOCOMPLETE="off"></td><td></tr>
    <tr><td>Passwort wdh:*</td><td><input type="password" name="repassword" value="[REPASSWORD]" size="40" AUTOCOMPLETE="off"></td><td></tr>
    ...
    <tr><td>Startseite:</td><td><input type="text" name="startseite" value="[STARTSEITE]" size="40">&nbsp;<i>z.B. index.php?module=welcome&action=pinwand</i>&nbsp;(für Pinwand)</td><td></tr>
    <tr><td>Fehllogins:</td><td><input type="text" name="fehllogins" value="[FEHLLOGINS]" size="40">&nbsp;<i>Z&auml;hler bei falschen Logins. Zum zur&uuml;cksetzten Feld leeren.</i></td><td></tr>
    <tr><td>Vorlage:</td><td><input type="text" name="vorlage" value="[VORLAGE]" size="40"></td><td></tr>
...
<fieldset><legend>Externer Login (wenn freigegeben)</legend>
    <table width="100%">
          ...
          <tr><td>Picosafe Login AES:</td><td><input type="text" name="hwkey" value="[HWKEY]" size="40"></td></tr>
          <tr><td>Picosafe Login Counter:</td><td><input type="text" name="hwcounter" value="[HWCOUNTER]" size="40"></td></tr>
          <tr><td>Picosafe Login Datablock:</td><td><input type="text" name="hwdatablock" value="[HWDATABLOCK]" size="40"></td></tr>
...
<fieldset><legend>Sonstige Einstellungen</legend>
    <table width="100%">
        ...
        <tr valign="top"><td>Eigene E-Mail bevorzugen:</td><td><input type="checkbox" name="email_bevorzugen" value="1" [EMAILBEVORZUGENCHECKED]>&nbsp;<i>(Immer eigene E-Mail vor Firmenadresse bevorzugen.)</i></td></tr>
         ...
         <tr><td>Im Kalender ausblenden:</td><td><input type="checkbox" name="kalender_ausblenden" value="1" [KALENDERAUSBLENDENCHECKED]>&nbsp;<i>(Benutzer ausblenden)</i></td></tr>
...
<div id="tabs-2">
<fieldset><legend>Standard Vorlage</legend>
	<form action="" id="userrightsform" method="POST">
		<table><tr><td width="300">Rechte-Vorlage:</td><td><select name="usertemplate" style="margin-left: 15px">[USERTEMPLATES]</select>
		<input type="button" name="templatesubmit" value="&uuml;bernehmen" style="margin-left: 15px" 
			onclick="if(!confirm('Es werden alle Benutzerrechte überschrieben. Fortfahren?')) return false;else document.getElementById('userrightsform').submit();">
		  </td></tr></table>
	</form>
</fieldset>
<br><br>
<fieldset><legend>Rechte von Benutzer kopieren</legend>
	<form action="" id="copyuserrightsform" method="POST">
		<table><tr><td width="300">Rechte von Benutzer kopieren:</td><td><select name="copyusertemplate" style="margin-left: 15px">[USERNAMESELECT]</select>
