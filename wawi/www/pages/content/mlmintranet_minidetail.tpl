...
//-->
</script><div id="mlmintranet_minidetail_[ID]">
...
<div style="width:900px; height:100%; background-color:white; padding:20px;">
  <div>
		<h2>Ger&auml;te</h2><hr><p>[GERAETE]</p>
		<br><h2>Serviceartikel</h2><hr>[SERVICEARTIKEL]
  ...
  <div>[RMA]</div>-->
<br><br>
<center><button onclick="printContent('mlmintranet_minidetail_[ID]')">Drucken</button></center>
</div>
