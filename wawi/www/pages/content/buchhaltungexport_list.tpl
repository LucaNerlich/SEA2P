...
<table >
<tr><td width="100">von</td><td><input type="text" size="12" id="von3" name="von3" value="[VON3]">&nbsp;[DATUM3]</td></tr>
<tr><td>bis</td><td><input type="text" size="12" name="bis3" id="bis3" value="[BIS3]">&nbsp;[DATUM3]&nbsp;<input type="submit" name="exportverbindlichkeit" value="Export"></td></tr>
...
<table>
<tr><td width="100">von</td><td><input type="text" size="12" name="von2" id="von2" value="[VON2]">&nbsp;[DATUMVON2]</td></tr>
<tr><td>bis</td><td><input type="text" size="12" name="bis2" id="bis2" value="[BIS2]">&nbsp;[DATUMBIS2]&nbsp;<input type="submit" name="buchhaltungexport" value="Export"></td></tr>
</table>
</fieldset>
</form>
...
<table>
<tr><td width="100">Auswahl</td><td>
<input type="button" value="Kunden" onclick="window.location.href='index.php?module=buchhaltungexport&action=exportadressen&cmd=kunden'">&nbsp;
<input type="button" value="Lieferanten" onclick="window.location.href='index.php?module=buchhaltungexport&action=exportadressen&cmd=lieferanten'">&nbsp;
[BUTTONVERBAND]
</td></tr>
