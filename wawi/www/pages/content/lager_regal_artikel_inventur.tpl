...
&nbsp;<input type="button" onclick="window.location.href='index.php?module=lager&action=bestand&id=[ID]'" value="Zur&uuml;ck zum Lager" name="back">
...
&nbsp;<input type="button" onclick="if(!confirm('Soll die Inventur jetzt abgeschlossen werden? Alle Anpassungen werden &uuml;bernommen und der anschlie&szlig;end neue Lagerbestand gesondert als Inventur Stand: [STAND] gespeichert.')) return false; else window.location.href='index.php?module=lager&action=inventur&cmd=einfrieren&id=[ID]';" value="[KURZUEBERSCHRIFT2] einfrieren.">
&nbsp;<input type="button" onclick="if(!confirm('Soll die Inventur jetzt zur&uuml;ckgesetz werden? Alle Anpassungen werden gel&ouml;scht.')) return false; else window.location.href='index.php?module=lager&action=inventur&cmd=resetlagerplatz&lager_platz=[LAGERPLATZID]&id=[ID]';" value="Inventur f&uuml;r Regalplatz [LAGERPLATZ] zur&uuml;cksetzten.">
