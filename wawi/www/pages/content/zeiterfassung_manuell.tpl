...
<input type="button" value="2 Std" onclick="BerechneEndzeit(120);">
 ...
 <tr><td width="250"></td><td colspan="3"><i>Bitte nur die Arbeitszeiten (keine Pausen) buchen.</i></td></tr>
...
<table id="projektrow" style="display:[PROJEKTROW]">
	...
	<tr><td>Kunde:</td><td>[ADRESSE_ABRECHNUNGAUTOSTART]<input type="text" id="adresse_abrechnung" size="72" name="adresse_abrechnung" value="[ADRESSE_ABRECHNUNG]">[ADRESSE_ABRECHNUNGAUTOEND]</td></tr>

	<tr><td>Abrechnen:</td><td><input type="checkbox" name="abrechnen" value="1" [ABRECHNEN]>&nbsp;<i>Bitte ausw&auml;hlen, wenn Dienstleistung abgerechnet werden soll oder Bestandteil eines Supportvertrags war.</i></td></tr>
