...
<div style="width:900px; height:100%; background-color:white; padding:20px;">
  <div>
		<h2>Artikel Direktvertrieb</h2><hr><p>[POSITIONENDIREKT]</p>
		<h2>Artikel aus Downline</h2><hr><p>[POSITIONENDOWNLINE]</p>
		<h2>Direktpr&auml;mie</h2><hr><p>[POSITIONENKOPFGELD]</p>
		<h2>Manuelle Positionen bzw. Wartekonto</h2><hr><p>[POSITIONENMANUELL]</p>
			</div>
