...
<table class="tableborder" border="0" cellpadding="3" cellspacing="3" width="70%">
...
<!--            <tr><td><b>Eigenschaften</b></td><td></td><td>&nbsp;</td><td></td></tr>-->
	    ...
	    <tr><td>Datei:</td><td colspan="3"><input type="file" name="upload" style="width: 230px;"></td></tr>
[STARTDISABLE]
	    <tr><td>Titel</td><td colspan="3"><input type="text" style="width: 230px;" name="titel" value="[TITEL]"></td></tr>
	    <tr><td>Beschreibung:</td><td colspan="3"><textarea style="width: 230px;height: 100px;" value="beschreibung">[BESCHREIBUNG]</textarea></td></tr>


	    <tr valign="middle"><td>Stichwort:</td><td colspan="3">
	      <table>
	      <tr> 
	      <td><select name="stichwort">
		<option value="Sonstige">Sonstige Datei</option>
		<option value="anhang">Anhang</option>
		<option value="Shopbild">Standard Artikelbild</option>
		<option value="Gruppenbild">Standard Gruppenbild</option>
		<option value="Bild">Sonstiges Bild</option>
		<option value="Briefpapier1">Briefpapier Seite 1</option>
		<option value="Briefpapier2">Briefpapier Seite 2</option>
		<option value="Datenblatt">Datenblatt</option>
		<option value="Druckbild">Druckbild (300dpi)</option>
	      </select></td>
	      <td></td>
	      <td>
		</td>
