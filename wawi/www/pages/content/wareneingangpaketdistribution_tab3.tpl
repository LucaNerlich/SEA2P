...
<tr valign="top"><td><br></td><td align="center"></td></tr> 
<tr valign="top"><td nowrap><b>1. Schritt:</b></td><td><input type="radio" name="anzahlauswahl" checked>&nbsp;<input type="text" size="5" value="[MENGE]" readonly>&nbsp;Etiketten 
drucken (VPE: [VPE]).<br>
<input type="radio" name="anzahlauswahl">&nbsp;<input type="text" size="5" value="[ANZAHL]">&nbsp;St&uuml;ck weil anders geliefert
  </td></tr> 
<tr valign="top"><td><br></td><td align="center"></td></tr> 
<tr valign="top"><td><b>2. Schritt:</b></td><td>Etikettarten&nbsp;<select><option>Artikelaufkleber klein</option><option>Artikelaufkleber groß</option></select>
<tr valign="top"><td><br></td><td align="center"></td></tr> 
...
<br><br>
    ...
    value="Etiketten drucken und Artikel einlagern" /></td>
    </tr>
