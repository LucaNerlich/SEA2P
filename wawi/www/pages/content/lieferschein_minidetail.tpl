...
<tr><td class="auftraginfo_cell">Auftrag:</td><td class="auftraginfo_cell">[RECHNUNG]</td><td class="auftraginfo_cell">Versteuerung:</td><td class="auftraginfo_cell">[STEUER]</td></tr>
...
<div width="100%" style="background-color:#999;"><h2 class="greyh2">Artikel2</h2></div>
