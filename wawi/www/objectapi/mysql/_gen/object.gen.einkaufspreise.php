...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO einkaufspreise (id,artikel,adresse,objekt,projekt,preis,waehrung,ab_menge,vpe,preis_anfrage_vom,gueltig_bis,lieferzeit_standard,lieferzeit_aktuell,lager_lieferant,datum_lagerlieferant,bestellnummer,bezeichnunglieferant,sicherheitslager,bemerkung,bearbeiter,logdatei,standard,geloescht,firma)
      VALUES('','{$this->artikel}','{$this->adresse}','{$this->objekt}','{$this->projekt}','{$this->preis}','{$this->waehrung}','{$this->ab_menge}','{$this->vpe}','{$this->preis_anfrage_vom}','{$this->gueltig_bis}','{$this->lieferzeit_standard}','{$this->lieferzeit_aktuell}','{$this->lager_lieferant}','{$this->datum_lagerlieferant}','{$this->bestellnummer}','{$this->bezeichnunglieferant}','{$this->sicherheitslager}','{$this->bemerkung}','{$this->bearbeiter}','{$this->logdatei}','{$this->standard}','{$this->geloescht}','{$this->firma}')"; 
