...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO ansprechpartner (id,typ,sprache,name,bereich,abteilung,unterabteilung,land,strasse,ort,plz,telefon,telefax,email,sonstiges,adresszusatz,steuer,adresse,logdatei,mobil,titel,anschreiben,ansprechpartner_land)
      VALUES('','{$this->typ}','{$this->sprache}','{$this->name}','{$this->bereich}','{$this->abteilung}','{$this->unterabteilung}','{$this->land}','{$this->strasse}','{$this->ort}','{$this->plz}','{$this->telefon}','{$this->telefax}','{$this->email}','{$this->sonstiges}','{$this->adresszusatz}','{$this->steuer}','{$this->adresse}','{$this->logdatei}','{$this->mobil}','{$this->titel}','{$this->anschreiben}','{$this->ansprechpartner_land}')"; 
