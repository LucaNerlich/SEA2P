...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO auftrag_position (id,auftrag,artikel,projekt,bezeichnung,beschreibung,internerkommentar,nummer,menge,preis,waehrung,lieferdatum,vpe,sort,status,umsatzsteuer,bemerkung,geliefert,geliefert_menge,explodiert,explodiert_parent,logdatei,rabatt,nachbestelltexternereinkauf,einheit,punkte,bonuspunkte,mlmdirektpraemie,rabatt1,rabatt2,rabatt3,rabatt4,rabatt5,keinrabatterlaubt,grundrabatt,rabattsync,webid)
      VALUES('','{$this->auftrag}','{$this->artikel}','{$this->projekt}','{$this->bezeichnung}','{$this->beschreibung}','{$this->internerkommentar}','{$this->nummer}','{$this->menge}','{$this->preis}','{$this->waehrung}','{$this->lieferdatum}','{$this->vpe}','{$this->sort}','{$this->status}','{$this->umsatzsteuer}','{$this->bemerkung}','{$this->geliefert}','{$this->geliefert_menge}','{$this->explodiert}','{$this->explodiert_parent}','{$this->logdatei}','{$this->rabatt}','{$this->nachbestelltexternereinkauf}','{$this->einheit}','{$this->punkte}','{$this->bonuspunkte}','{$this->mlmdirektpraemie}','{$this->rabatt1}','{$this->rabatt2}','{$this->rabatt3}','{$this->rabatt4}','{$this->rabatt5}','{$this->keinrabatterlaubt}','{$this->grundrabatt}','{$this->rabattsync}','{$this->webid}')"; 
