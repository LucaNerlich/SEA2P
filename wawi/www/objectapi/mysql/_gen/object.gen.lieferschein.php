...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO lieferschein (id,datum,projekt,lieferscheinart,belegnr,bearbeiter,auftrag,auftragid,freitext,status,adresse,name,abteilung,unterabteilung,strasse,adresszusatz,ansprechpartner,plz,ort,land,ustid,email,telefon,telefax,betreff,kundennummer,versandart,versand,firma,versendet,versendet_am,versendet_per,versendet_durch,inbearbeitung_user,logdatei,ohne_briefpapier,pdfarchiviert,pdfarchiviertversion,schreibschutz,ust_befreit,internebemerkung,ihrebestellnummer,typ,anschreiben,vertriebid,usereditid,useredittimestamp,vertrieb,lieferantenretoure,lieferant)
