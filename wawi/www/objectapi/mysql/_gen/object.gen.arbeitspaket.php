...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO arbeitspaket (id,adresse,aufgabe,beschreibung,projekt,zeit_geplant,kostenstelle,status,abgabe,abgenommen,abgenommen_von,abgenommen_bemerkung,initiator,art,abgabedatum,logdatei,geloescht,auftragid,vorgaenger,kosten_geplant,artikel_geplant)
      VALUES('','{$this->adresse}','{$this->aufgabe}','{$this->beschreibung}','{$this->projekt}','{$this->zeit_geplant}','{$this->kostenstelle}','{$this->status}','{$this->abgabe}','{$this->abgenommen}','{$this->abgenommen_von}','{$this->abgenommen_bemerkung}','{$this->initiator}','{$this->art}','{$this->abgabedatum}','{$this->logdatei}','{$this->geloescht}','{$this->auftragid}','{$this->vorgaenger}','{$this->kosten_geplant}','{$this->artikel_geplant}')"; 
