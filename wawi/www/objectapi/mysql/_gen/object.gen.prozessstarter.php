...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO prozessstarter (id,bezeichnung,bedingung,art,startzeit,letzteausfuerhung,periode,typ,parameter,aktiv,mutex,mutexcounter,firma)
      VALUES('','{$this->bezeichnung}','{$this->bedingung}','{$this->art}','{$this->startzeit}','{$this->letzteausfuerhung}','{$this->periode}','{$this->typ}','{$this->parameter}','{$this->aktiv}','{$this->mutex}','{$this->mutexcounter}','{$this->firma}')"; 
