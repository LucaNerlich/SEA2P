...
class ObjGenEigenschaften
{
  ...
  public function ObjGenEigenschaften($app)
  {
    $this->app = $app;
  }
...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO eigenschaften (id,artikel,art,bezeichnung,beschreibung,menge,einheit,menge2,einheit2,menge3,einheit3,wert,wert2,wert3)
      VALUES('','{$this->artikel}','{$this->art}','{$this->bezeichnung}','{$this->beschreibung}','{$this->menge}','{$this->einheit}','{$this->menge2}','{$this->einheit2}','{$this->menge3}','{$this->einheit3}','{$this->wert}','{$this->wert2}','{$this->wert3}')"; 
