...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO rechnung (id,datum,aborechnung,projekt,anlegeart,belegnr,auftrag,auftragid,bearbeiter,freitext,status,adresse,name,abteilung,unterabteilung,strasse,adresszusatz,ansprechpartner,plz,ort,land,ustid,ust_befreit,ustbrief,ustbrief_eingang,ustbrief_eingang_am,email,telefon,telefax,betreff,kundennummer,lieferschein,versandart,lieferdatum,buchhaltung,zahlungsweise,zahlungsstatus,ist,soll,skonto_gegeben,zahlungszieltage,zahlungszieltageskonto,zahlungszielskonto,firma,versendet,versendet_am,versendet_per,versendet_durch,versendet_mahnwesen,mahnwesen,mahnwesen_datum,mahnwesen_gesperrt,mahnwesen_internebemerkung,inbearbeitung,datev_abgeschlossen,logdatei,doppel,keinsteuersatz,internebemerkung,ohne_briefpapier,pdfarchiviert,pdfarchiviertversion,schreibschutz,forderungsverlust_datum,forderungsverlust_betrag,ihrebestellnummer,steuersatz_normal,steuersatz_zwischen,steuersatz_ermaessigt,steuersatz_starkermaessigt,steuersatz_dienstleistung,waehrung,punkte,bonuspunkte,provdatum,typ,anschreiben,rabatt,realrabatt,rabatt1,rabatt2,rabatt3,rabatt4,rabatt5,gruppe,vertriebid,provision,provision_summe,autodruck_rz,autodruck_periode,autodruck_done,autodruck_anzahlverband,autodruck_anzahlkunde,autodruck_mailverband,autodruck_mailkunde,usereditid,useredittimestamp,vertrieb,dta_datei_verband,aktion,deckungsbeitrag,erloes_netto,deckungsbeitragcalc,einzugsdatum,dta_datei,umsatz_netto,mahnwesenfestsetzen)
      VALUES('','{$this->datum}','{$this->aborechnung}','{$this->projekt}','{$this->anlegeart}','{$this->belegnr}','{$this->auftrag}','{$this->auftragid}','{$this->bearbeiter}','{$this->freitext}','{$this->status}','{$this->adresse}','{$this->name}','{$this->abteilung}','{$this->unterabteilung}','{$this->strasse}','{$this->adresszusatz}','{$this->ansprechpartner}','{$this->plz}','{$this->ort}','{$this->land}','{$this->ustid}','{$this->ust_befreit}','{$this->ustbrief}','{$this->ustbrief_eingang}','{$this->ustbrief_eingang_am}','{$this->email}','{$this->telefon}','{$this->telefax}','{$this->betreff}','{$this->kundennummer}','{$this->lieferschein}','{$this->versandart}','{$this->lieferdatum}','{$this->buchhaltung}','{$this->zahlungsweise}','{$this->zahlungsstatus}','{$this->ist}','{$this->soll}','{$this->skonto_gegeben}','{$this->zahlungszieltage}','{$this->zahlungszieltageskonto}','{$this->zahlungszielskonto}','{$this->firma}','{$this->versendet}','{$this->versendet_am}','{$this->versendet_per}','{$this->versendet_durch}','{$this->versendet_mahnwesen}','{$this->mahnwesen}','{$this->mahnwesen_datum}','{$this->mahnwesen_gesperrt}','{$this->mahnwesen_internebemerkung}','{$this->inbearbeitung}','{$this->datev_abgeschlossen}','{$this->logdatei}','{$this->doppel}','{$this->keinsteuersatz}','{$this->internebemerkung}','{$this->ohne_briefpapier}','{$this->pdfarchiviert}','{$this->pdfarchiviertversion}','{$this->schreibschutz}','{$this->forderungsverlust_datum}','{$this->forderungsverlust_betrag}','{$this->ihrebestellnummer}','{$this->steuersatz_normal}','{$this->steuersatz_zwischen}','{$this->steuersatz_ermaessigt}','{$this->steuersatz_starkermaessigt}','{$this->steuersatz_dienstleistung}','{$this->waehrung}','{$this->punkte}','{$this->bonuspunkte}','{$this->provdatum}','{$this->typ}','{$this->anschreiben}','{$this->rabatt}','{$this->realrabatt}','{$this->rabatt1}','{$this->rabatt2}','{$this->rabatt3}','{$this->rabatt4}','{$this->rabatt5}','{$this->gruppe}','{$this->vertriebid}','{$this->provision}','{$this->provision_summe}','{$this->autodruck_rz}','{$this->autodruck_periode}','{$this->autodruck_done}','{$this->autodruck_anzahlverband}','{$this->autodruck_anzahlkunde}','{$this->autodruck_mailverband}','{$this->autodruck_mailkunde}','{$this->usereditid}','{$this->useredittimestamp}','{$this->vertrieb}','{$this->dta_datei_verband}','{$this->aktion}','{$this->deckungsbeitrag}','{$this->erloes_netto}','{$this->deckungsbeitragcalc}','{$this->einzugsdatum}','{$this->dta_datei}','{$this->umsatz_netto}','{$this->mahnwesenfestsetzen}')"; 
