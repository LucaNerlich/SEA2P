...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO gutschrift (id,datum,projekt,anlegeart,belegnr,rechnung,rechnungid,bearbeiter,freitext,status,adresse,name,abteilung,unterabteilung,strasse,adresszusatz,plz,ort,land,ustid,ustbrief,ustbrief_eingang,ustbrief_eingang_am,ust_befreit,email,telefon,telefax,betreff,kundennummer,lieferschein,versandart,lieferdatum,buchhaltung,zahlungsweise,zahlungsstatus,ist,soll,zahlungszieltage,zahlungszieltageskonto,zahlungszielskonto,gesamtsumme,bank_inhaber,bank_institut,bank_blz,bank_konto,kreditkarte_typ,kreditkarte_inhaber,kreditkarte_nummer,kreditkarte_pruefnummer,kreditkarte_monat,kreditkarte_jahr,paypalaccount,firma,versendet,versendet_am,versendet_per,versendet_durch,inbearbeitung,logdatei,keinsteuersatz,internebemerkung,stornorechnung,ohne_briefpapier,pdfarchiviert,pdfarchiviertversion,schreibschutz,ihrebestellnummer,steuersatz_normal,steuersatz_zwischen,steuersatz_ermaessigt,steuersatz_starkermaessigt,steuersatz_dienstleistung,waehrung,typ,anschreiben,rabatt,realrabatt,rabatt1,rabatt2,rabatt3,rabatt4,rabatt5,gruppe,provision,provision_summe,usereditid,useredittimestamp,vertriebid,vertrieb,dta_datei_verband,aktion,deckungsbeitrag,erloes_netto,deckungsbeitragcalc,umsatz_netto,manuell_vorabbezahlt_hinweis,dta_datei,manuell_vorabbezahlt,nicht_umsatzmindernd)
      VALUES('','{$this->datum}','{$this->projekt}','{$this->anlegeart}','{$this->belegnr}','{$this->rechnung}','{$this->rechnungid}','{$this->bearbeiter}','{$this->freitext}','{$this->status}','{$this->adresse}','{$this->name}','{$this->abteilung}','{$this->unterabteilung}','{$this->strasse}','{$this->adresszusatz}','{$this->plz}','{$this->ort}','{$this->land}','{$this->ustid}','{$this->ustbrief}','{$this->ustbrief_eingang}','{$this->ustbrief_eingang_am}','{$this->ust_befreit}','{$this->email}','{$this->telefon}','{$this->telefax}','{$this->betreff}','{$this->kundennummer}','{$this->lieferschein}','{$this->versandart}','{$this->lieferdatum}','{$this->buchhaltung}','{$this->zahlungsweise}','{$this->zahlungsstatus}','{$this->ist}','{$this->soll}','{$this->zahlungszieltage}','{$this->zahlungszieltageskonto}','{$this->zahlungszielskonto}','{$this->gesamtsumme}','{$this->bank_inhaber}','{$this->bank_institut}','{$this->bank_blz}','{$this->bank_konto}','{$this->kreditkarte_typ}','{$this->kreditkarte_inhaber}','{$this->kreditkarte_nummer}','{$this->kreditkarte_pruefnummer}','{$this->kreditkarte_monat}','{$this->kreditkarte_jahr}','{$this->paypalaccount}','{$this->firma}','{$this->versendet}','{$this->versendet_am}','{$this->versendet_per}','{$this->versendet_durch}','{$this->inbearbeitung}','{$this->logdatei}','{$this->keinsteuersatz}','{$this->internebemerkung}','{$this->stornorechnung}','{$this->ohne_briefpapier}','{$this->pdfarchiviert}','{$this->pdfarchiviertversion}','{$this->schreibschutz}','{$this->ihrebestellnummer}','{$this->steuersatz_normal}','{$this->steuersatz_zwischen}','{$this->steuersatz_ermaessigt}','{$this->steuersatz_starkermaessigt}','{$this->steuersatz_dienstleistung}','{$this->waehrung}','{$this->typ}','{$this->anschreiben}','{$this->rabatt}','{$this->realrabatt}','{$this->rabatt1}','{$this->rabatt2}','{$this->rabatt3}','{$this->rabatt4}','{$this->rabatt5}','{$this->gruppe}','{$this->provision}','{$this->provision_summe}','{$this->usereditid}','{$this->useredittimestamp}','{$this->vertriebid}','{$this->vertrieb}','{$this->dta_datei_verband}','{$this->aktion}','{$this->deckungsbeitrag}','{$this->erloes_netto}','{$this->deckungsbeitragcalc}','{$this->umsatz_netto}','{$this->manuell_vorabbezahlt_hinweis}','{$this->dta_datei}','{$this->manuell_vorabbezahlt}','{$this->nicht_umsatzmindernd}')"; 
