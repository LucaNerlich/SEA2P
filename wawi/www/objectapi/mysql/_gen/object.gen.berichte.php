...
class ObjGenBerichte
{
  ...
  public function ObjGenBerichte($app)
  {
    $this->app = $app;
  }
...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO berichte (id,name,beschreibung,internebemerkung,struktur,spaltennamen,spaltenbreite,spaltenausrichtung)
      VALUES('','{$this->name}','{$this->beschreibung}','{$this->internebemerkung}','{$this->struktur}','{$this->spaltennamen}','{$this->spaltenbreite}','{$this->spaltenausrichtung}')"; 
 ...
 /** dank dieser funktionen kann man die tatsaechlichen werte einfach 
  ...
  function SetStruktur($value) { $this->struktur=$value; }
  function GetStruktur() { return $this->struktur; }
  function SetSpaltennamen($value) { $this->spaltennamen=$value; }
  function GetSpaltennamen() { return $this->spaltennamen; }
  function SetSpaltenbreite($value) { $this->spaltenbreite=$value; }
  function GetSpaltenbreite() { return $this->spaltenbreite; }
  function SetSpaltenausrichtung($value) { $this->spaltenausrichtung=$value; }
  function GetSpaltenausrichtung() { return $this->spaltenausrichtung; }
