...
class ObjGenFirma
{
  ...
  public function ObjGenFirma($app)
  {
    $this->app = $app;
  }
...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO firma (id,name,standardprojekt)
      VALUES(DEFAULT, '{$this->name}', ".((is_numeric($this->standardprojekt)) ? $this->standardprojekt : '0').")"; 
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE firma SET
      name='{$this->name}',
      standardprojekt=".((is_numeric($this->standardprojekt)) ? $this->standardprojekt : '0')."
      WHERE (id='{$this->id}')";
