...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO shopexport_status (id,artikelexport,bearbeiter,zeit,bemerkung,befehl)
      VALUES(DEFAULT, ".((is_numeric($this->artikelexport)) ? $this->artikelexport : '0').", '{$this->bearbeiter}', ".(($this->zeit=='' || $this->zeit=='--') ? 'NOW()' : "'".$this->zeit."'").", '{$this->bemerkung}', '{$this->befehl}')"; 
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE shopexport_status SET
      artikelexport=".((is_numeric($this->artikelexport)) ? $this->artikelexport : '0').",
