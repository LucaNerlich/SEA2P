...
class ObjGenWebmail_Mails
{
  ...
  public function ObjGenWebmail_Mails($app)
  {
    $this->app = $app;
  }
...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO webmail_mails (id,webmail,subject,sender,cc,bcc,replyto,plaintext,htmltext,empfang,anhang,gelesen,checksum)
      VALUES(DEFAULT, ".((is_numeric($this->webmail)) ? $this->webmail : '0').", '{$this->subject}', '{$this->sender}', '{$this->cc}', '{$this->bcc}', '{$this->replyto}', '{$this->plaintext}', '{$this->htmltext}', ".(($this->empfang=='' || $this->empfang=='--') ? 'NOW()' : "'".$this->empfang."'").", ".((is_numeric($this->anhang)) ? $this->anhang : '0').", ".((is_numeric($this->gelesen)) ? $this->gelesen : '0').", '{$this->checksum}')"; 
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE webmail_mails SET
      ...
      anhang=".((is_numeric($this->anhang)) ? $this->anhang : '0').",
