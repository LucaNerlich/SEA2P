...
class ObjGenArbeitsnachweis_Protokoll
{
  ...
  public function ObjGenArbeitsnachweis_Protokoll($app)
  {
    $this->app = $app;
  }
...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO arbeitsnachweis_protokoll (id,arbeitsnachweis,zeit,bearbeiter,grund)
      VALUES(DEFAULT, ".((is_numeric($this->arbeitsnachweis)) ? $this->arbeitsnachweis : '0').", ".(($this->zeit=='' || $this->zeit=='--') ? 'NOW()' : "'".$this->zeit."'").", '{$this->bearbeiter}', '{$this->grund}')"; 
