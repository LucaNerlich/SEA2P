...
class ObjGenDatei
{
  ...
  public function ObjGenDatei($app)
  {
    $this->app = $app;
  }
...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO datei (id,titel,beschreibung,nummer,geloescht,logdatei,firma)
      VALUES(DEFAULT, '{$this->titel}', '{$this->beschreibung}', '{$this->nummer}', ".((is_numeric($this->geloescht)) ? $this->geloescht : '0').", ".(($this->logdatei=='' || $this->logdatei=='--') ? 'NOW()' : "'".$this->logdatei."'").", ".((is_numeric($this->firma)) ? $this->firma : '0').")"; 
