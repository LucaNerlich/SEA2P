...
class ObjGenGutschrift_Protokoll
{
  ...
  public function ObjGenGutschrift_Protokoll($app)
  {
    $this->app = $app;
  }
...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO gutschrift_protokoll (id,gutschrift,zeit,bearbeiter,grund)
      VALUES(DEFAULT, ".((is_numeric($this->gutschrift)) ? $this->gutschrift : '0').", ".(($this->zeit=='' || $this->zeit=='--') ? 'NOW()' : "'".$this->zeit."'").", '{$this->bearbeiter}', '{$this->grund}')"; 
