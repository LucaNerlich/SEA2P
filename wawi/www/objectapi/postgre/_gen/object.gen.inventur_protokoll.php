...
class ObjGenInventur_Protokoll
{
  ...
  public function ObjGenInventur_Protokoll($app)
  {
    $this->app = $app;
  }
...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO inventur_protokoll (id,inventur,zeit,bearbeiter,grund)
      VALUES(DEFAULT, ".((is_numeric($this->inventur)) ? $this->inventur : '0').", ".(($this->zeit=='' || $this->zeit=='--') ? 'NOW()' : "'".$this->zeit."'").", '{$this->bearbeiter}', '{$this->grund}')"; 
