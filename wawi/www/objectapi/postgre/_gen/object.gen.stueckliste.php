...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO stueckliste (id,sort,artikel,referenz,place,layer,stuecklistevonartikel,menge,firma,wert,bauform)
      VALUES(DEFAULT, ".((is_numeric($this->sort)) ? $this->sort : '0').", ".((is_numeric($this->artikel)) ? $this->artikel : '0').", '{$this->referenz}', '{$this->place}', '{$this->layer}', ".((is_numeric($this->stuecklistevonartikel)) ? $this->stuecklistevonartikel : '0').", ".((is_numeric($this->menge)) ? $this->menge : '0').", ".((is_numeric($this->firma)) ? $this->firma : '0').", '{$this->wert}', '{$this->bauform}')"; 
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE stueckliste SET
      ...
      place='{$this->place}',
      layer='{$this->layer}',
      stuecklistevonartikel=".((is_numeric($this->stuecklistevonartikel)) ? $this->stuecklistevonartikel : '0').",
