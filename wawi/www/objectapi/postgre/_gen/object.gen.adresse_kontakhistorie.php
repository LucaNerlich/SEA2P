...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO adresse_kontakhistorie (id,adresse,grund,beschreibung,bearbeiter,datum,logdatei)
      VALUES(DEFAULT, ".((is_numeric($this->adresse)) ? $this->adresse : '0').", '{$this->grund}', '{$this->beschreibung}', '{$this->bearbeiter}', ".(($this->datum=='' || $this->datum=='--') ? 'NOW()' : "'".$this->datum."'").", ".(($this->logdatei=='' || $this->logdatei=='--') ? 'NOW()' : "'".$this->logdatei."'").")"; 
