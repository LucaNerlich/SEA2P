...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO partner (id,adresse,ref,bezeichnung,netto,tage,projekt,geloescht,firma)
      VALUES(DEFAULT, ".((is_numeric($this->adresse)) ? $this->adresse : '0').", '{$this->ref}', '{$this->bezeichnung}', ".((is_numeric($this->netto)) ? $this->netto : '0').", ".((is_numeric($this->tage)) ? $this->tage : '0').", ".((is_numeric($this->projekt)) ? $this->projekt : '0').", ".((is_numeric($this->geloescht)) ? $this->geloescht : '0').", ".((is_numeric($this->firma)) ? $this->firma : '0').")"; 
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE partner SET
      ...
      netto=".((is_numeric($this->netto)) ? $this->netto : '0').",
      tage=".((is_numeric($this->tage)) ? $this->tage : '0').",
