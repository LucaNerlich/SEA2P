...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO inventur_position (id,inventur,artikel,nummer,projekt,bezeichnung,beschreibung,internerkommentar,menge,sort,bemerkung,preis,exportiert_am,logdatei)
      VALUES(DEFAULT, ".((is_numeric($this->inventur)) ? $this->inventur : '0').", ".((is_numeric($this->artikel)) ? $this->artikel : '0').", '{$this->nummer}', ".((is_numeric($this->projekt)) ? $this->projekt : '0').", '{$this->bezeichnung}', '{$this->beschreibung}', '{$this->internerkommentar}', '{$this->menge}', ".((is_numeric($this->sort)) ? $this->sort : '0').", '{$this->bemerkung}', ".((is_numeric($this->preis)) ? $this->preis : '0').", ".(($this->exportiert_am=='' || $this->exportiert_am=='--') ? 'NOW()' : "'".$this->exportiert_am."'").", ".(($this->logdatei=='' || $this->logdatei=='--') ? 'NOW()' : "'".$this->logdatei."'").")"; 
