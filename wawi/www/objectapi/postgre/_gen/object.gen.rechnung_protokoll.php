...
class ObjGenRechnung_Protokoll
{
  ...
  public function ObjGenRechnung_Protokoll($app)
  {
    $this->app = $app;
  }
...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO rechnung_protokoll (id,rechnung,zeit,bearbeiter,grund)
      VALUES(DEFAULT, ".((is_numeric($this->rechnung)) ? $this->rechnung : '0').", ".(($this->zeit=='' || $this->zeit=='--') ? 'NOW()' : "'".$this->zeit."'").", '{$this->bearbeiter}', '{$this->grund}')"; 
