...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO lager (id,bezeichnung,beschreibung,manuell,firma,geloescht,logdatei)
      VALUES(DEFAULT, '{$this->bezeichnung}', '{$this->beschreibung}', ".((is_numeric($this->manuell)) ? $this->manuell : '0').", ".((is_numeric($this->firma)) ? $this->firma : '0').", ".((is_numeric($this->geloescht)) ? $this->geloescht : '0').", ".(($this->logdatei=='' || $this->logdatei=='--') ? 'NOW()' : "'".$this->logdatei."'").")"; 
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE lager SET
      ...
      manuell=".((is_numeric($this->manuell)) ? $this->manuell : '0').",
