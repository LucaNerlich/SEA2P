...
class ObjGenDatei_Version
{
  ...
  public function ObjGenDatei_Version($app)
  {
    $this->app = $app;
  }
...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO datei_version (id,datei,ersteller,datum,version,dateiname,bemerkung,logdatei)
      VALUES(DEFAULT, ".((is_numeric($this->datei)) ? $this->datei : '0').", '{$this->ersteller}', ".(($this->datum=='' || $this->datum=='--') ? 'NOW()' : "'".$this->datum."'").", ".((is_numeric($this->version)) ? $this->version : '0').", '{$this->dateiname}', '{$this->bemerkung}', ".(($this->logdatei=='' || $this->logdatei=='--') ? 'NOW()' : "'".$this->logdatei."'").")"; 
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE datei_version SET
      ...
      version=".((is_numeric($this->version)) ? $this->version : '0').",
