...
class ObjGenDatei_Stichwoerter
{
  ...
  public function ObjGenDatei_Stichwoerter($app)
  {
    $this->app = $app;
  }
...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO datei_stichwoerter (id,datei,subjekt,objekt,parameter,logdatei)
      VALUES(DEFAULT, ".((is_numeric($this->datei)) ? $this->datei : '0').", '{$this->subjekt}', '{$this->objekt}', '{$this->parameter}', ".(($this->logdatei=='' || $this->logdatei=='--') ? 'NOW()' : "'".$this->logdatei."'").")"; 
