...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO auftrag (id,datum,art,projekt,belegnr,internet,bearbeiter,angebot,freitext,internebemerkung,status,adresse,name,abteilung,unterabteilung,strasse,adresszusatz,ansprechpartner,plz,ort,land,ustid,ust_befreit,ust_inner,email,telefon,telefax,betreff,kundennummer,versandart,vertrieb,zahlungsweise,zahlungszieltage,zahlungszieltageskonto,zahlungszielskonto,bank_inhaber,bank_institut,bank_blz,bank_konto,kreditkarte_typ,kreditkarte_inhaber,kreditkarte_nummer,kreditkarte_pruefnummer,kreditkarte_monat,kreditkarte_jahr,firma,versendet,versendet_am,versendet_per,versendet_durch,autoversand,keinporto,keinestornomail,abweichendelieferadresse,liefername,lieferabteilung,lieferunterabteilung,lieferland,lieferstrasse,lieferort,lieferplz,lieferadresszusatz,lieferansprechpartner,packstation_inhaber,packstation_station,packstation_ident,packstation_plz,packstation_ort,autofreigabe,freigabe,nachbesserung,gesamtsumme,inbearbeitung,abgeschlossen,nachlieferung,lager_ok,porto_ok,ust_ok,check_ok,vorkasse_ok,nachnahme_ok,reserviert_ok,partnerid,folgebestaetigung,zahlungsmail,stornogrund,stornosonstiges,stornorueckzahlung,stornobetrag,stornobankinhaber,stornobankkonto,stornobankblz,stornobankbank,stornogutschrift,stornogutschriftbeleg,stornowareerhalten,stornomanuellebearbeitung,stornokommentar,stornobezahlt,stornobezahltam,stornobezahltvon,stornoabgeschlossen,stornorueckzahlungper,stornowareerhaltenretour,partnerausgezahlt,partnerausgezahltam,kennen,logdatei,keinetrackingmail,zahlungsmailcounter,keinsteuersatz,angebotid,ohne_briefpapier,pdfarchiviert,pdfarchiviertversion,schreibschutz,ihrebestellnummer)
      VALUES(DEFAULT, ".(($this->datum=='' || $this->datum=='--') ? 'NOW()' : "'".$this->datum."'").", '{$this->art}', '{$this->projekt}', '{$this->belegnr}', '{$this->internet}', '{$this->bearbeiter}', '{$this->angebot}', '{$this->freitext}', '{$this->internebemerkung}', '{$this->status}', ".((is_numeric($this->adresse)) ? $this->adresse : '0').", '{$this->name}', '{$this->abteilung}', '{$this->unterabteilung}', '{$this->strasse}', '{$this->adresszusatz}', '{$this->ansprechpartner}', '{$this->plz}', '{$this->ort}', '{$this->land}', '{$this->ustid}', ".((is_numeric($this->ust_befreit)) ? $this->ust_befreit : '0').", ".((is_numeric($this->ust_inner)) ? $this->ust_inner : '0').", '{$this->email}', '{$this->telefon}', '{$this->telefax}', '{$this->betreff}', '{$this->kundennummer}', '{$this->versandart}', '{$this->vertrieb}', '{$this->zahlungsweise}', ".((is_numeric($this->zahlungszieltage)) ? $this->zahlungszieltage : '0').", ".((is_numeric($this->zahlungszieltageskonto)) ? $this->zahlungszieltageskonto : '0').", ".((is_numeric($this->zahlungszielskonto)) ? $this->zahlungszielskonto : '0').", '{$this->bank_inhaber}', '{$this->bank_institut}', '{$this->bank_blz}', '{$this->bank_konto}', '{$this->kreditkarte_typ}', '{$this->kreditkarte_inhaber}', '{$this->kreditkarte_nummer}', '{$this->kreditkarte_pruefnummer}', '{$this->kreditkarte_monat}', '{$this->kreditkarte_jahr}', ".((is_numeric($this->firma)) ? $this->firma : '0').", ".((is_numeric($this->versendet)) ? $this->versendet : '0').", ".(($this->versendet_am=='' || $this->versendet_am=='--') ? 'NOW()' : "'".$this->versendet_am."'").", '{$this->versendet_per}', '{$this->versendet_durch}', ".((is_numeric($this->autoversand)) ? $this->autoversand : '0').", ".((is_numeric($this->keinporto)) ? $this->keinporto : '0').", ".((is_numeric($this->keinestornomail)) ? $this->keinestornomail : '0').", ".((is_numeric($this->abweichendelieferadresse)) ? $this->abweichendelieferadresse : '0').", '{$this->liefername}', '{$this->lieferabteilung}', '{$this->lieferunterabteilung}', '{$this->lieferland}', '{$this->lieferstrasse}', '{$this->lieferort}', '{$this->lieferplz}', '{$this->lieferadresszusatz}', '{$this->lieferansprechpartner}', '{$this->packstation_inhaber}', '{$this->packstation_station}', '{$this->packstation_ident}', '{$this->packstation_plz}', '{$this->packstation_ort}', ".((is_numeric($this->autofreigabe)) ? $this->autofreigabe : '0').", ".((is_numeric($this->freigabe)) ? $this->freigabe : '0').", ".((is_numeric($this->nachbesserung)) ? $this->nachbesserung : '0').", ".((is_numeric($this->gesamtsumme)) ? $this->gesamtsumme : '0').", ".((is_numeric($this->inbearbeitung)) ? $this->inbearbeitung : '0').", ".((is_numeric($this->abgeschlossen)) ? $this->abgeschlossen : '0').", ".((is_numeric($this->nachlieferung)) ? $this->nachlieferung : '0').", ".((is_numeric($this->lager_ok)) ? $this->lager_ok : '0').", ".((is_numeric($this->porto_ok)) ? $this->porto_ok : '0').", ".((is_numeric($this->ust_ok)) ? $this->ust_ok : '0').", ".((is_numeric($this->check_ok)) ? $this->check_ok : '0').", ".((is_numeric($this->vorkasse_ok)) ? $this->vorkasse_ok : '0').", ".((is_numeric($this->nachnahme_ok)) ? $this->nachnahme_ok : '0').", ".((is_numeric($this->reserviert_ok)) ? $this->reserviert_ok : '0').", ".((is_numeric($this->partnerid)) ? $this->partnerid : '0').", ".(($this->folgebestaetigung=='' || $this->folgebestaetigung=='--') ? 'NOW()' : "'".$this->folgebestaetigung."'").", ".(($this->zahlungsmail=='' || $this->zahlungsmail=='--') ? 'NOW()' : "'".$this->zahlungsmail."'").", '{$this->stornogrund}', '{$this->stornosonstiges}', '{$this->stornorueckzahlung}', ".((is_numeric($this->stornobetrag)) ? $this->stornobetrag : '0').", '{$this->stornobankinhaber}', '{$this->stornobankkonto}', '{$this->stornobankblz}', '{$this->stornobankbank}', ".((is_numeric($this->stornogutschrift)) ? $this->stornogutschrift : '0').", '{$this->stornogutschriftbeleg}', ".((is_numeric($this->stornowareerhalten)) ? $this->stornowareerhalten : '0').", '{$this->stornomanuellebearbeitung}', '{$this->stornokommentar}', '{$this->stornobezahlt}', ".(($this->stornobezahltam=='' || $this->stornobezahltam=='--') ? 'NOW()' : "'".$this->stornobezahltam."'").", '{$this->stornobezahltvon}', ".((is_numeric($this->stornoabgeschlossen)) ? $this->stornoabgeschlossen : '0').", '{$this->stornorueckzahlungper}', ".((is_numeric($this->stornowareerhaltenretour)) ? $this->stornowareerhaltenretour : '0').", ".((is_numeric($this->partnerausgezahlt)) ? $this->partnerausgezahlt : '0').", ".(($this->partnerausgezahltam=='' || $this->partnerausgezahltam=='--') ? 'NOW()' : "'".$this->partnerausgezahltam."'").", '{$this->kennen}', ".(($this->logdatei=='' || $this->logdatei=='--') ? 'NOW()' : "'".$this->logdatei."'").", ".((is_numeric($this->keinetrackingmail)) ? $this->keinetrackingmail : '0').", ".((is_numeric($this->zahlungsmailcounter)) ? $this->zahlungsmailcounter : '0').", ".((is_numeric($this->keinsteuersatz)) ? $this->keinsteuersatz : '0').", ".((is_numeric($this->angebotid)) ? $this->angebotid : '0').", ".((is_numeric($this->ohne_briefpapier)) ? $this->ohne_briefpapier : '0').", ".((is_numeric($this->pdfarchiviert)) ? $this->pdfarchiviert : '0').", ".((is_numeric($this->pdfarchiviertversion)) ? $this->pdfarchiviertversion : '0').", ".((is_numeric($this->schreibschutz)) ? $this->schreibschutz : '0').", '{$this->ihrebestellnummer}')"; 
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE auftrag SET
      ...
      ust_inner=".((is_numeric($this->ust_inner)) ? $this->ust_inner : '0').",
      email='{$this->email}',
      ...
      keinestornomail=".((is_numeric($this->keinestornomail)) ? $this->keinestornomail : '0').",
      ...
      autofreigabe=".((is_numeric($this->autofreigabe)) ? $this->autofreigabe : '0').",
      freigabe=".((is_numeric($this->freigabe)) ? $this->freigabe : '0').",
      nachbesserung=".((is_numeric($this->nachbesserung)) ? $this->nachbesserung : '0').",
      ...
      nachlieferung=".((is_numeric($this->nachlieferung)) ? $this->nachlieferung : '0').",
      lager_ok=".((is_numeric($this->lager_ok)) ? $this->lager_ok : '0').",
      porto_ok=".((is_numeric($this->porto_ok)) ? $this->porto_ok : '0').",
      ust_ok=".((is_numeric($this->ust_ok)) ? $this->ust_ok : '0').",
      check_ok=".((is_numeric($this->check_ok)) ? $this->check_ok : '0').",
      vorkasse_ok=".((is_numeric($this->vorkasse_ok)) ? $this->vorkasse_ok : '0').",
      nachnahme_ok=".((is_numeric($this->nachnahme_ok)) ? $this->nachnahme_ok : '0').",
      reserviert_ok=".((is_numeric($this->reserviert_ok)) ? $this->reserviert_ok : '0').",
      partnerid=".((is_numeric($this->partnerid)) ? $this->partnerid : '0').",
      folgebestaetigung=".(($this->folgebestaetigung=='' || $this->folgebestaetigung=='--') ? 'NOW()' : "'".$this->folgebestaetigung."'").",
      zahlungsmail=".(($this->zahlungsmail=='' || $this->zahlungsmail=='--') ? 'NOW()' : "'".$this->zahlungsmail."'").",
      stornogrund='{$this->stornogrund}',
      stornosonstiges='{$this->stornosonstiges}',
      stornorueckzahlung='{$this->stornorueckzahlung}',
      stornobetrag=".((is_numeric($this->stornobetrag)) ? $this->stornobetrag : '0').",
      ...
      stornogutschrift=".((is_numeric($this->stornogutschrift)) ? $this->stornogutschrift : '0').",
      stornogutschriftbeleg='{$this->stornogutschriftbeleg}',
      stornowareerhalten=".((is_numeric($this->stornowareerhalten)) ? $this->stornowareerhalten : '0').",
      ...
      stornobezahltam=".(($this->stornobezahltam=='' || $this->stornobezahltam=='--') ? 'NOW()' : "'".$this->stornobezahltam."'").",
      stornobezahltvon='{$this->stornobezahltvon}',
      stornoabgeschlossen=".((is_numeric($this->stornoabgeschlossen)) ? $this->stornoabgeschlossen : '0').",
      stornorueckzahlungper='{$this->stornorueckzahlungper}',
      stornowareerhaltenretour=".((is_numeric($this->stornowareerhaltenretour)) ? $this->stornowareerhaltenretour : '0').",
      partnerausgezahlt=".((is_numeric($this->partnerausgezahlt)) ? $this->partnerausgezahlt : '0').",
      partnerausgezahltam=".(($this->partnerausgezahltam=='' || $this->partnerausgezahltam=='--') ? 'NOW()' : "'".$this->partnerausgezahltam."'").",
      kennen='{$this->kennen}',
      ...
      zahlungsmailcounter=".((is_numeric($this->zahlungsmailcounter)) ? $this->zahlungsmailcounter : '0').",
      keinsteuersatz=".((is_numeric($this->keinsteuersatz)) ? $this->keinsteuersatz : '0').",
      angebotid=".((is_numeric($this->angebotid)) ? $this->angebotid : '0').",
