...
class ObjGenProduktion
{
  ...
  public function ObjGenProduktion($app)
  {
    $this->app = $app;
  }
...
$result = $result[0];
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE produktion SET
      ...
      datumproduktion=".(($this->datumproduktion=='' || $this->datumproduktion=='--') ? 'NOW()' : "'".$this->datumproduktion."'").",
