...
class ObjGenGeschaeftsbrief_Vorlagen
{
  ...
  public function ObjGenGeschaeftsbrief_Vorlagen($app)
  {
    $this->app = $app;
  }
...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO geschaeftsbrief_vorlagen (id,sprache,betreff,text,subjekt,projekt,firma)
      VALUES(DEFAULT, '{$this->sprache}', '{$this->betreff}', '{$this->text}', '{$this->subjekt}', ".((is_numeric($this->projekt)) ? $this->projekt : '0').", ".((is_numeric($this->firma)) ? $this->firma : '0').")"; 
