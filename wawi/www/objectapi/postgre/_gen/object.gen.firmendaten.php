...
class ObjGenFirmendaten
{
  ...
  public function ObjGenFirmendaten($app)
  {
    $this->app = $app;
  }
...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO firmendaten (id,firma,absender,sichtbar,barcode,schriftgroesse,betreffszeile,dokumententext,tabellenbeschriftung,tabelleninhalt,zeilenuntertext,freitext,infobox,spaltenbreite,footer_0_0,footer_0_1,footer_0_2,footer_0_3,footer_0_4,footer_0_5,footer_1_0,footer_1_1,footer_1_2,footer_1_3,footer_1_4,footer_1_5,footer_2_0,footer_2_1,footer_2_2,footer_2_3,footer_2_4,footer_2_5,footer_3_0,footer_3_1,footer_3_2,footer_3_3,footer_3_4,footer_3_5,footersichtbar,hintergrund,logo,logo_type,briefpapier,briefpapier_type,benutzername,passwort,host,port,mailssl,signatur,email,absendername,bcc1,bcc2,firmenfarbe,name,strasse,plz,ort,steuernummer,startseite_wiki,datum,projekt,brieftext,next_angebot,next_auftrag,next_gutschrift,next_lieferschein,next_bestellung,next_rechnung,next_kundennummer,next_lieferantennummer,next_mitarbeiternummer,next_waren,next_sonstiges,next_produktion,next_kundennumer,next_produktionen,wareneingang_kamera_waage,layout_iconbar,seite_von_ausrichtung,seite_von_sichtbar,rechnung_header,lieferschein_header,angebot_header,auftrag_header,gutschrift_header,bestellung_header,rechnung_footer,lieferschein_footer,angebot_footer,auftrag_footer,gutschrift_footer,bestellung_footer,eu_lieferung_vermerk,rechnung_ohnebriefpapier,lieferschein_ohnebriefpapier,angebot_ohnebriefpapier,auftrag_ohnebriefpapier,gutschrift_ohnebriefpapier,bestellung_ohnebriefpapier,abstand_adresszeileoben,abstand_boxrechtsoben,abstand_betreffzeileoben,abstand_artikeltabelleoben,arbeitsnachweis_header,arbeitsnachweis_footer,arbeitsnachweis_ohnebriefpapier,next_arbeitsnachweis,parameterundfreifelder,freifeld1,freifeld2,freifeld3,freifeld4,freifeld5,freifeld6,artikel_suche_kurztext,externeinkauf,schriftart,externereinkauf,next_reisekosten,projektnummerimdokument,mailanstellesmtp,herstellernummerimdokument,standardmarge,zahlungsweise,zahlungszieltage,zahlungszielskonto,zahlungszieltageskonto,zahlung_rechnung,zahlung_vorkasse,zahlung_nachnahme,zahlung_kreditkarte,zahlung_paypal,zahlung_bar,zahlung_lastschrift,zahlung_rechnung_sofort_de,zahlung_rechnung_de,knickfalz)
      VALUES(DEFAULT, ".((is_numeric($this->firma)) ? $this->firma : '0').", '{$this->absender}', ".((is_numeric($this->sichtbar)) ? $this->sichtbar : '0').", ".((is_numeric($this->barcode)) ? $this->barcode : '0').", ".((is_numeric($this->schriftgroesse)) ? $this->schriftgroesse : '0').", ".((is_numeric($this->betreffszeile)) ? $this->betreffszeile : '0').", ".((is_numeric($this->dokumententext)) ? $this->dokumententext : '0').", ".((is_numeric($this->tabellenbeschriftung)) ? $this->tabellenbeschriftung : '0').", ".((is_numeric($this->tabelleninhalt)) ? $this->tabelleninhalt : '0').", ".((is_numeric($this->zeilenuntertext)) ? $this->zeilenuntertext : '0').", ".((is_numeric($this->freitext)) ? $this->freitext : '0').", ".((is_numeric($this->infobox)) ? $this->infobox : '0').", ".((is_numeric($this->spaltenbreite)) ? $this->spaltenbreite : '0').", '{$this->footer_0_0}', '{$this->footer_0_1}', '{$this->footer_0_2}', '{$this->footer_0_3}', '{$this->footer_0_4}', '{$this->footer_0_5}', '{$this->footer_1_0}', '{$this->footer_1_1}', '{$this->footer_1_2}', '{$this->footer_1_3}', '{$this->footer_1_4}', '{$this->footer_1_5}', '{$this->footer_2_0}', '{$this->footer_2_1}', '{$this->footer_2_2}', '{$this->footer_2_3}', '{$this->footer_2_4}', '{$this->footer_2_5}', '{$this->footer_3_0}', '{$this->footer_3_1}', '{$this->footer_3_2}', '{$this->footer_3_3}', '{$this->footer_3_4}', '{$this->footer_3_5}', ".((is_numeric($this->footersichtbar)) ? $this->footersichtbar : '0').", '{$this->hintergrund}', '{$this->logo}', '{$this->logo_type}', '{$this->briefpapier}', '{$this->briefpapier_type}', '{$this->benutzername}', '{$this->passwort}', '{$this->host}', '{$this->port}', ".((is_numeric($this->mailssl)) ? $this->mailssl : '0').", '{$this->signatur}', '{$this->email}', '{$this->absendername}', '{$this->bcc1}', '{$this->bcc2}', '{$this->firmenfarbe}', '{$this->name}', '{$this->strasse}', '{$this->plz}', '{$this->ort}', '{$this->steuernummer}', '{$this->startseite_wiki}', ".(($this->datum=='' || $this->datum=='--') ? 'NOW()' : "'".$this->datum."'").", ".((is_numeric($this->projekt)) ? $this->projekt : '0').", '{$this->brieftext}', '{$this->next_angebot}', '{$this->next_auftrag}', '{$this->next_gutschrift}', '{$this->next_lieferschein}', '{$this->next_bestellung}', '{$this->next_rechnung}', '{$this->next_kundennummer}', '{$this->next_lieferantennummer}', '{$this->next_mitarbeiternummer}', '{$this->next_waren}', '{$this->next_sonstiges}', '{$this->next_produktion}', '{$this->next_kundennumer}', '{$this->next_produktionen}', ".((is_numeric($this->wareneingang_kamera_waage)) ? $this->wareneingang_kamera_waage : '0').", ".((is_numeric($this->layout_iconbar)) ? $this->layout_iconbar : '0').", '{$this->seite_von_ausrichtung}', ".((is_numeric($this->seite_von_sichtbar)) ? $this->seite_von_sichtbar : '0').", '{$this->rechnung_header}', '{$this->lieferschein_header}', '{$this->angebot_header}', '{$this->auftrag_header}', '{$this->gutschrift_header}', '{$this->bestellung_header}', '{$this->rechnung_footer}', '{$this->lieferschein_footer}', '{$this->angebot_footer}', '{$this->auftrag_footer}', '{$this->gutschrift_footer}', '{$this->bestellung_footer}', '{$this->eu_lieferung_vermerk}', ".((is_numeric($this->rechnung_ohnebriefpapier)) ? $this->rechnung_ohnebriefpapier : '0').", ".((is_numeric($this->lieferschein_ohnebriefpapier)) ? $this->lieferschein_ohnebriefpapier : '0').", ".((is_numeric($this->angebot_ohnebriefpapier)) ? $this->angebot_ohnebriefpapier : '0').", ".((is_numeric($this->auftrag_ohnebriefpapier)) ? $this->auftrag_ohnebriefpapier : '0').", ".((is_numeric($this->gutschrift_ohnebriefpapier)) ? $this->gutschrift_ohnebriefpapier : '0').", ".((is_numeric($this->bestellung_ohnebriefpapier)) ? $this->bestellung_ohnebriefpapier : '0').", ".((is_numeric($this->abstand_adresszeileoben)) ? $this->abstand_adresszeileoben : '0').", ".((is_numeric($this->abstand_boxrechtsoben)) ? $this->abstand_boxrechtsoben : '0').", ".((is_numeric($this->abstand_betreffzeileoben)) ? $this->abstand_betreffzeileoben : '0').", ".((is_numeric($this->abstand_artikeltabelleoben)) ? $this->abstand_artikeltabelleoben : '0').", '{$this->arbeitsnachweis_header}', '{$this->arbeitsnachweis_footer}', ".((is_numeric($this->arbeitsnachweis_ohnebriefpapier)) ? $this->arbeitsnachweis_ohnebriefpapier : '0').", '{$this->next_arbeitsnachweis}', ".((is_numeric($this->parameterundfreifelder)) ? $this->parameterundfreifelder : '0').", '{$this->freifeld1}', '{$this->freifeld2}', '{$this->freifeld3}', '{$this->freifeld4}', '{$this->freifeld5}', '{$this->freifeld6}', ".((is_numeric($this->artikel_suche_kurztext)) ? $this->artikel_suche_kurztext : '0').", ".((is_numeric($this->externeinkauf)) ? $this->externeinkauf : '0').", '{$this->schriftart}', ".((is_numeric($this->externereinkauf)) ? $this->externereinkauf : '0').", '{$this->next_reisekosten}', ".((is_numeric($this->projektnummerimdokument)) ? $this->projektnummerimdokument : '0').", ".((is_numeric($this->mailanstellesmtp)) ? $this->mailanstellesmtp : '0').", ".((is_numeric($this->herstellernummerimdokument)) ? $this->herstellernummerimdokument : '0').", ".((is_numeric($this->standardmarge)) ? $this->standardmarge : '0').", '{$this->zahlungsweise}', ".((is_numeric($this->zahlungszieltage)) ? $this->zahlungszieltage : '0').", ".((is_numeric($this->zahlungszielskonto)) ? $this->zahlungszielskonto : '0').", ".((is_numeric($this->zahlungszieltageskonto)) ? $this->zahlungszieltageskonto : '0').", ".((is_numeric($this->zahlung_rechnung)) ? $this->zahlung_rechnung : '0').", ".((is_numeric($this->zahlung_vorkasse)) ? $this->zahlung_vorkasse : '0').", ".((is_numeric($this->zahlung_nachnahme)) ? $this->zahlung_nachnahme : '0').", ".((is_numeric($this->zahlung_kreditkarte)) ? $this->zahlung_kreditkarte : '0').", ".((is_numeric($this->zahlung_paypal)) ? $this->zahlung_paypal : '0').", ".((is_numeric($this->zahlung_bar)) ? $this->zahlung_bar : '0').", ".((is_numeric($this->zahlung_lastschrift)) ? $this->zahlung_lastschrift : '0').", '{$this->zahlung_rechnung_sofort_de}', '{$this->zahlung_rechnung_de}', ".((is_numeric($this->knickfalz)) ? $this->knickfalz : '0').")"; 
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE firmendaten SET
      ...
      barcode=".((is_numeric($this->barcode)) ? $this->barcode : '0').",
      schriftgroesse=".((is_numeric($this->schriftgroesse)) ? $this->schriftgroesse : '0').",
      betreffszeile=".((is_numeric($this->betreffszeile)) ? $this->betreffszeile : '0').",
      dokumententext=".((is_numeric($this->dokumententext)) ? $this->dokumententext : '0').",
      tabellenbeschriftung=".((is_numeric($this->tabellenbeschriftung)) ? $this->tabellenbeschriftung : '0').",
      tabelleninhalt=".((is_numeric($this->tabelleninhalt)) ? $this->tabelleninhalt : '0').",
      zeilenuntertext=".((is_numeric($this->zeilenuntertext)) ? $this->zeilenuntertext : '0').",
      freitext=".((is_numeric($this->freitext)) ? $this->freitext : '0').",
      infobox=".((is_numeric($this->infobox)) ? $this->infobox : '0').",
      spaltenbreite=".((is_numeric($this->spaltenbreite)) ? $this->spaltenbreite : '0').",
      ...
      footersichtbar=".((is_numeric($this->footersichtbar)) ? $this->footersichtbar : '0').",
      ...
      host='{$this->host}',
      port='{$this->port}',
      mailssl=".((is_numeric($this->mailssl)) ? $this->mailssl : '0').",
      ...
      wareneingang_kamera_waage=".((is_numeric($this->wareneingang_kamera_waage)) ? $this->wareneingang_kamera_waage : '0').",
      layout_iconbar=".((is_numeric($this->layout_iconbar)) ? $this->layout_iconbar : '0').",
      seite_von_ausrichtung='{$this->seite_von_ausrichtung}',
      seite_von_sichtbar=".((is_numeric($this->seite_von_sichtbar)) ? $this->seite_von_sichtbar : '0').",
      ...
      rechnung_ohnebriefpapier=".((is_numeric($this->rechnung_ohnebriefpapier)) ? $this->rechnung_ohnebriefpapier : '0').",
      lieferschein_ohnebriefpapier=".((is_numeric($this->lieferschein_ohnebriefpapier)) ? $this->lieferschein_ohnebriefpapier : '0').",
      angebot_ohnebriefpapier=".((is_numeric($this->angebot_ohnebriefpapier)) ? $this->angebot_ohnebriefpapier : '0').",
      auftrag_ohnebriefpapier=".((is_numeric($this->auftrag_ohnebriefpapier)) ? $this->auftrag_ohnebriefpapier : '0').",
      gutschrift_ohnebriefpapier=".((is_numeric($this->gutschrift_ohnebriefpapier)) ? $this->gutschrift_ohnebriefpapier : '0').",
      bestellung_ohnebriefpapier=".((is_numeric($this->bestellung_ohnebriefpapier)) ? $this->bestellung_ohnebriefpapier : '0').",
      abstand_adresszeileoben=".((is_numeric($this->abstand_adresszeileoben)) ? $this->abstand_adresszeileoben : '0').",
      abstand_boxrechtsoben=".((is_numeric($this->abstand_boxrechtsoben)) ? $this->abstand_boxrechtsoben : '0').",
      abstand_betreffzeileoben=".((is_numeric($this->abstand_betreffzeileoben)) ? $this->abstand_betreffzeileoben : '0').",
      abstand_artikeltabelleoben=".((is_numeric($this->abstand_artikeltabelleoben)) ? $this->abstand_artikeltabelleoben : '0').",
      arbeitsnachweis_header='{$this->arbeitsnachweis_header}',
      arbeitsnachweis_footer='{$this->arbeitsnachweis_footer}',
      arbeitsnachweis_ohnebriefpapier=".((is_numeric($this->arbeitsnachweis_ohnebriefpapier)) ? $this->arbeitsnachweis_ohnebriefpapier : '0').",
      next_arbeitsnachweis='{$this->next_arbeitsnachweis}',
      parameterundfreifelder=".((is_numeric($this->parameterundfreifelder)) ? $this->parameterundfreifelder : '0').",
      ...
      artikel_suche_kurztext=".((is_numeric($this->artikel_suche_kurztext)) ? $this->artikel_suche_kurztext : '0').",
      externeinkauf=".((is_numeric($this->externeinkauf)) ? $this->externeinkauf : '0').",
      schriftart='{$this->schriftart}',
      externereinkauf=".((is_numeric($this->externereinkauf)) ? $this->externereinkauf : '0').",
      next_reisekosten='{$this->next_reisekosten}',
      projektnummerimdokument=".((is_numeric($this->projektnummerimdokument)) ? $this->projektnummerimdokument : '0').",
      mailanstellesmtp=".((is_numeric($this->mailanstellesmtp)) ? $this->mailanstellesmtp : '0').",
      herstellernummerimdokument=".((is_numeric($this->herstellernummerimdokument)) ? $this->herstellernummerimdokument : '0').",
      standardmarge=".((is_numeric($this->standardmarge)) ? $this->standardmarge : '0').",
      ...
      zahlung_rechnung=".((is_numeric($this->zahlung_rechnung)) ? $this->zahlung_rechnung : '0').",
      zahlung_vorkasse=".((is_numeric($this->zahlung_vorkasse)) ? $this->zahlung_vorkasse : '0').",
      zahlung_nachnahme=".((is_numeric($this->zahlung_nachnahme)) ? $this->zahlung_nachnahme : '0').",
      zahlung_kreditkarte=".((is_numeric($this->zahlung_kreditkarte)) ? $this->zahlung_kreditkarte : '0').",
      zahlung_paypal=".((is_numeric($this->zahlung_paypal)) ? $this->zahlung_paypal : '0').",
      zahlung_bar=".((is_numeric($this->zahlung_bar)) ? $this->zahlung_bar : '0').",
      zahlung_lastschrift=".((is_numeric($this->zahlung_lastschrift)) ? $this->zahlung_lastschrift : '0').",
      zahlung_rechnung_sofort_de='{$this->zahlung_rechnung_sofort_de}',
      zahlung_rechnung_de='{$this->zahlung_rechnung_de}',
      knickfalz=".((is_numeric($this->knickfalz)) ? $this->knickfalz : '0')."
      WHERE (id='{$this->id}')";
