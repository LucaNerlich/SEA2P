...
class ObjGenBestellung_Protokoll
{
  ...
  public function ObjGenBestellung_Protokoll($app)
  {
    $this->app = $app;
  }
...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO bestellung_protokoll (id,bestellung,zeit,bearbeiter,grund)
      VALUES(DEFAULT, ".((is_numeric($this->bestellung)) ? $this->bestellung : '0').", ".(($this->zeit=='' || $this->zeit=='--') ? 'NOW()' : "'".$this->zeit."'").", '{$this->bearbeiter}', '{$this->grund}')"; 
