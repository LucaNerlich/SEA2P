...
$result = $result[0];
  ...
  public function Create()
  {
    $sql = "INSERT INTO aufgabe_erledigt (id,adresse,aufgabe,abgeschlossen_am,logdatei)
      VALUES(DEFAULT, ".((is_numeric($this->adresse)) ? $this->adresse : '0').", ".((is_numeric($this->aufgabe)) ? $this->aufgabe : '0').", ".(($this->abgeschlossen_am=='' || $this->abgeschlossen_am=='--') ? 'NOW()' : "'".$this->abgeschlossen_am."'").", ".(($this->logdatei=='' || $this->logdatei=='--') ? 'NOW()' : "'".$this->logdatei."'").")"; 
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE aufgabe_erledigt SET
      ...
      aufgabe=".((is_numeric($this->aufgabe)) ? $this->aufgabe : '0').",
