...
*                                                                              *
*******************************************************************************/
function FPDFWAWISION($orientation='P',$unit='mm',$format='A4')
{
	//Some checks
	$this->_dochecks();
	...
	if(is_string($format))
	{
		...
		elseif($format=='a5')
			$format=array(419.52,595.28);
		elseif($format=='a5+')
			$format=array(425.20,600.96);
		elseif($format=='a6')
			$format=array(297.64,419.52);			
		elseif($format=='letter')
			$format=array(612,792);
		elseif($format=='legal')
			$format=array(612,1008);
		elseif($format=='v1')
			$format=array(240.94,155.90);
		elseif($format=='visis')
			$format=array(340.15,280.77);			
		else
