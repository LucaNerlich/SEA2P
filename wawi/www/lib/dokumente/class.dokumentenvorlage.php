...
class Dokumentenvorlage extends SuperFPDF {
   ...
   ***********************************/  
  function Dokumentenvorlage(&$app,$projekt="") {
 ...
 */ 
  ...
  public function Header() {
    ...
    if($this->dokumentenvorlage!="")
      $this->setStationery($this->dokumentenvorlage);
  }  
...
$priceWidth = 15;
  ...
  */
 	...
 	public function renderTextBox($infoBox,$height=5) 
	{
		...
		{
			$this->MultiCell(190,$height,$this->app->erp->ReadyForPDF($infoBox),"",'L');
		}
	}
