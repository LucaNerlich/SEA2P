...
class KatalogPDF extends SuperFPDF 
{
  ...
  function KatalogPDF($app)
  {
    $this->app = &$app;
    parent::SuperFPDF('P','mm','A5');
...
*/ 
	...
	$this->SetFont('HelveticaCond','','5');
        $this->SetTextColor(50, 50, 50);
        $this->MultiCell($this->spaltenbreite,2.5,"Bestellnr.: ".$bestellnr." | "."Preis: ".number_format($preis,2,'.','')." EUR",$borderDebug,'L');
