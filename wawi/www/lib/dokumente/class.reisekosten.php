...
class ReisekostenPDF extends Dokumentenvorlage {
  ...
  function ReisekostenPDF($app,$projekt="")
  {
    ...
    {
      $y = $this->GetY();
      $this->Code39(175, $y+1, $this->barcode, 1, 5);
    }
...
/*
		$titles[] = array("Pos","L","L",20);
		$titles[] = array("Beschreibung","L","L",100);
		$titles[] = array("Brutto","L","R",30);
		$titles[] = array("MwSt","L","C",30);
		$titles[] = array("Netto","L","R",30);
*/
...
//    $summe_infofields[]=array("Summe netto","34,23 EUR");
//    $summe_infofields[]=array("Summe brutto","45,82 EUR");
